...
$nombre_archivo="Reporte planilla opcion cuota patronal";
...
if (isset($_POST['tableHeaders']) && isset($_POST['tableData'])) {
    ...
    $titulo5 = isset($elementos[4]) ? $elementos[4] : null;
    $titulo6 = isset($elementos[5]) ? $elementos[5] : null;
    ...
    $text .= str_pad(" ", 108)."  ".str_pad($titulo5, 10 )."\n";
    $text .= str_pad(" ", 270)."  ".str_pad($titulo6, 10 )."\n";
    $text .= str_pad(str_repeat("-", 320), 10 )."\n";


    /* los ceros son los titulos iniciales tamaño de las columnas*/
    $miArray = [0,0,0,0,0,0,5,60,20,20,20,20,20,20,20,20,20,20,20,20];
                $tamano2 = [5,60,20,20,20,20,20,20,20,20,20,20,20,20];
