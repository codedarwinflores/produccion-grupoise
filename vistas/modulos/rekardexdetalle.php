  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_empleado($codigo_empleado) {
                ...
                <table  class="table table-bordered table-striped dt-responsive" width="100%" id="tabladatos">
                    ...
                    <tbody> 
                        <?php
                            ...
                            $data_kardex=fun_kardex($fechadesde,$fechahasta,$condicion);
                            $cuenta=0;
                            foreach ($data_kardex as $val_kardex) {
                                ...
                                $html .= "<tr>";
                                $html .= "<td>EQUIPO:"."</td>";
                                $html .= "<td>".$val_kardex["codigo_equipo"]." ".$val_kardex["descripcion"]."</td>";
                                $html .= "<td>"."</td>";
                                $html .= "<td>"."</td>";
                                $html .= "<td>"."</td>";
                                ...
                                foreach ($data_kardex_his as $val_his) {
                                    ...
                                    $codigo_empleado=$val_his["empleado_kardexh"];
                                    ...
                                    foreach ($data_tran as $val_tran) {
                                        $nombre_tran=$val_tran["codigo"]." ".$val_tran["nombre"];
                                    ...
                                    $total=$cantidad_entrada-$cantidad_salida;
                                    $total_his+=$total;
                                    $html .= "<tr>";
