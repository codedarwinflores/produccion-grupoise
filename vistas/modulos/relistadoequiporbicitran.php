    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_tra_equipo_actual($fecha, $condicion) {
            ...
            ) and STR_TO_DATE(fecha_movimiento_his, '%d-%m-%Y') <= STR_TO_DATE('$fecha', '%d-%m-%Y') and tipoequipo_his='bicicleta' $condicion
                    ...
                    <tbody> 
                        <?php
                            ...
                            foreach ($data_movi_his as $va_movi) {
                                ...
                                $data_arma=bicicleta($codigo_equipo);
                                $nom_bici="";
                                $matri_bici="";
                                $venci_bici="";
                                $serie_bici="";
                                foreach ($data_arma as $val_arma) {
                                    $nom_bici=$val_arma["descripcion_bicicleta"];
                                    $matri_bici=""/* $val_arma["numero_matricula"] */;
                                    $venci_bici=""/* $val_arma["fecha_vencimiento"] */;
                                    $serie_bici=$val_arma["numero_serie"];
                                }
                                ...
                                $venci_bici = strtotime($venci_bici);
                                $venci_bici = date("d-m-Y", $venci_bici);
                                ...
                                $html .= "<td>".$nom_bici."</td>";
                                $html .= "<td>".$matri_bici."</td>";
                                $html .= "<td>".$venci_bici."</td>";
                                $html .= "<td>".$serie_bici."</td>";
