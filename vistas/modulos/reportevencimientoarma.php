 ...
 <style>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <a href='vistas/modulos/Reporte_vencimiento_armas.xlsx' download class="btn btn-primary btnreporte" style="display:none">
        Descargar archivo
      </a>
      ...
      <div class="col-md-12" align="center">
        <h3>REPORTE DE VENCIMIENTO DE MATRICULAS</h3>
      </div>
      <!-- *********************** -->
      ...
      <?php
        ...
        function armas($fecha) {
            $query = "SELECT * FROM `tbl_armas` WHERE fecha_vencimiento<='$fecha'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $row_armas["codigo"]?></td>
                                <td><?php echo $row_armas["descripcion_arma"]?></td>
                                <td><?php echo $row_armas["numero_serie"]?></td>
                                <td><?php echo $row_armas["numero_matricula"]?></td>
                                <td><?php echo $row_armas["carnet_armas"]?></td>
                                <?php
      ...
      <!-- ************************ -->
            ...
            <?php
                ...
                $header1 = array(
                    ...
                    '              '=>'string',//text
                    '             '=>'string',//text
                    'REPORTE DE VENCIMIENTO DE MATRICULAS'=>'string',
                    '           '=>'string',//text
                    ' '=>'string',
                    ''=>'string',
                );
                ...
                $writer->writeSheetHeader('Sheet1', $header0,$col_options = ['widths'=>[25,20,30,50,20,20,40,20,80,20,30,20,10,50,10,20,10,30,50,50,50]]);
                ...
                $writer->writeSheetHeader('Sheet1', $header2,$styles8);
                    ...
                    foreach($data_armas as $row_armas) {
                        ...
                        $codigo=$row_armas["codigo"];
                        $descripcion_arma =$row_armas["descripcion_arma"];
                        $numero_serie=$row_armas["numero_serie"];
                        $numero_matricula=$row_armas["numero_matricula"];
                        $carnet_armas=$row_armas["carnet_armas"];
                     

                        /* ********* */
                        $row_empleado = array();
                        $row_empleado[$fecha_vencimiento]='string';
                        $row_empleado[$codigo]='string';
                        $row_empleado[$descripcion_arma]='string';
                        $row_empleado[$numero_serie]='string';
                        $row_empleado[$numero_matricula]='string';
                        $row_empleado[$carnet_armas]='string';

                        $data_movimiento = movimiento_armas($codigo);
                        foreach($data_movimiento as $row_movimiento) {
                ...
                $writer->writeToFile('vistas/modulos/Reporte_vencimiento_armas.xlsx');
                ?>
