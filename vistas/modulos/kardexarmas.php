    ...
    <div class="box">
      ...
      <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
         ...
         <?php
            function kardex()
            {
                  $query01 = "SELECT kardex.id as idkardex,kardex.*,tbl_armas.*,tbl_transacciones_equipo.*
                  FROM kardex,tbl_armas,tbl_transacciones_equipo,tbl_clientes_ubicaciones
                  where kardex.transancion_kardex=tbl_transacciones_equipo.id and kardex.equipo_kardex=tbl_armas.codigo and kardex.ubicacion_kardex= tbl_clientes_ubicaciones.id";
           ...
           echo ' <tr>
                   ...
                   echo '<td>
                     ...
                     <div class="btn-group">
                       <a href="historialkardexarmas?id='.$value["equipo_kardex"].'" class="btn btn-info">Movimientos</a>
        ...
        <div class="modal-body">
          ...
          <input type="hidden" id="correlativo_kardex">
            ...
            <div class="form-group  col-md-12" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <select class="form-control input-lg  mi-selector kardex_armas" name="ubicacion_kardex" id="ubicacion_kardex">
                  ...
                  ?>
                    <option value="<?php echo $value["id"]?>" tabla='tbl_armas' cantidad_armas="<?php echo $value["cantidad_armas"]?>"><?php echo $value["nombre_ubicacion"] ?></option>
                  <?php
                   }
                  ?>
                </select>
            ...
            <table class="table table-bordered table-striped dt-responsive " width="100%">
              ...
              <tbody>
                <tr>
                  <td><span>Código-Descripción-Serie-Matricula</span></td>
                  <td></td>
                  <td></td>
                  <td></td>
                </tr>
                <tr>
                  ...
                  <select class="form-control mi-selector" name="equipo_kardex" id="equipo_kardex" equipo="arma">
                        ...
                        ?>
                          <option value="<?php echo $value["codigo"]?>" costos="<?php echo $value["precio_costo"]?>" descripcion="<?php echo $value["descripcion_arma"]?>"><?php echo $value["codigo"].'-'.$value["descripcion_arma"].'-'.$value["numero_serie"].'-'.$value["numero_matricula"] ?></option>
                        <?php
                        }
                        ?>
                      </select>
          ...
          <div class="btn btn-primary guardarproducto">Añadir</div>
            ...
            <input type="hidden" id="nombremodulo" value="armas"/>
