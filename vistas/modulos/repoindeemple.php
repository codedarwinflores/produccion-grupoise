 ...
 ?>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <input type="hidden" class="titulo_reportes" value="CALCULO DE INDEMNIZACIONES">
        
      <div class="table-responsive">
                <table  class="table table-bordered table-striped dt-responsive" width="100%" id="tabladatos">
                    <thead>
                        <tr>
                            <th class="colspan">CALCULO DE INDEMNIZACIONES</th>
                        </tr>
                        <tr>
                    ...
                    <tbody> 
                        <?php
                            ...
                            foreach ($data_empleados as $value) {
                                ...
                                $apellidos=trim(trim($value["primer_apellido"]).' '.trim($value["segundo_apellido"]).' '.trim($value["apellido_casada"]));
                                ...
                                $html .= "<td>".$numDias."</td>";
                                $html .= "<td>$ ".bcdiv($inde,'1', 2)."</td>";
                                $html .= "<td>$ ".bcdiv($porcentaje,'1', 2)."</td>";
                                $html .= "</tr>";

                                $inde_global+=bcdiv($inde,'1', 2);
                                $porcentaje_goblal+=bcdiv($porcentaje,'1', 2);
                            }
                            $html .= "<tr>";
                            $html .= "<td>"."</td>";
                            $html .= "<td>"."</td>";
                            ...
                            $html .= "<td>$".bcdiv($porcentaje_goblal,'1', 2)."</td>";
                            $html .= "</tr>";
                            echo $html;
                        ?>
