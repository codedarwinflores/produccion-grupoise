 ...
 -->
         ...
         <label for="" class="label_<?php echo $row['Field'];?>"></label> 
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg input_<?php echo $row['Field'];?> cargos_<?php echo $row['Field'];?>" name="editar<?php echo $row['Field'];?>" id="editar<?php echo $row['Field'];?>" placeholder="" value="" autocomplete="off" required>
