...
$esconder="";
 if($ubicacion!="*"){
    $esconder="style='display:none'";
      ...
      else if($tipoplanilla=="planilladevengo".$cambio_table.""){
        $cambio_table="_admin";
      }
?>
     ...
     <a href='todosreportes' class="btn btn-danger">
      ...
      <?php
        ...
        function devengos_table($idempleado1,$numero,$devengos_table_maestra) {
            $query = "SELECT * FROM tbl_devengo_descuento_planilla".$devengos_table_maestra." where  idempleado_devengo='$idempleado1' and codigo_planilla_devengo='$numero'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
                                    ...
                                    $datosCategoria2 = [];
                                        ...
                                        for ($i = 0; $i < $numFilas; $i++) {
                                            ...
                                            if (isset($datosCategoria2[$i])) {
                                                /* $total_descuento_global+=$datosCategoria2[$i]["valor_devengo_planilla"]; */
                                                /* echo '<td>' . $datosCategoria2[$i]["descripcion_devengo_descuento_planilla"] . '</td>';
                                                echo '<td>' . $datosCategoria2[$i]["valor_devengo_planilla"] . '</td>'; */
                                                echo"<td></td>";
                                                echo"<td></td>";
                                                echo"<td></td>";
                                                $total_descuento_global+=0;
