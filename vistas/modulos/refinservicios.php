  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_cliente_fechainicio($fechadesde,$fechahasta) {
            $query = "SELECT*FROM tbl_clientes_ubicaciones  
            where fecha_inicio >= '$fechadesde' and fecha_inicio <= '$fechahasta' and  fecha_fin='0000-00-00 00:00:00'
            order by rubro desc";  
        ...
        function fun_cliente_fechafin($fechadesde,$fechahasta) {
            $query = "SELECT*FROM tbl_clientes_ubicaciones  
            where fecha_fin >= '$fechadesde' and fecha_fin <= '$fechahasta' and  fecha_fin !='0000-00-00 00:00:00'
            order by rubro desc";  
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        ...
        /* $cliente_activo = $_POST["cliente"];
        $clientecontratos = $_POST["clientecontratos"]; */
        $condicion="";
      ...
      <div class="table-responsive">
                <table  class="table table-bordered table-striped dt-responsive" width="100%" id="tabladatos">
                    <thead>
                        <tr>
                            <th class="colspan">*** REPORTE DE CONTRATOS ***</th>
                        </tr>
                        <tr>
                    ...
                    <tbody> 
                        <?php
                            ...
                            $html .= "<tr>";
                            $html .= "<td class='colspan'>CUENTAS DESHABILITADAS"."</td>";
                            $html .= "</tr>";
                           

                            $html .= "<tr>";
                            $html .= "<td>No."."</td>";
                            $html .= "<td>CUENTA TIPO DE CTA"."</td>";
                            $html .= "<td>CLIENTE"."</td>";
                            $html .= "<td>VENDEDOR"."</td>";
                            $html .= "<td>VALOR"."</td>";
                            $html .= "<td>F. RETIRO"."</td>";
                            ...
                            $data_empleado=fun_cliente_fechafin($fecha_desde,$fecha_hasta);
                            $cuenta=0;
                            foreach ($data_empleado as $val_emple) {

                                $idubicacion=$val_emple["id"];
                                $data_factura=detalle($idubicacion);
                                $total_factura=0;
                                foreach ($data_factura as $subvalue) {
                                    $total_factura=$subvalue["total"];
                                }
                                $cuenta++;
                                $fecha_fin = strtotime($val_emple["fecha_fin"]);
                                $fecha_fin = date("d-m-Y", $fecha_fin);
                                $html .= "<tr>";
                                $html .= "<td>".str_pad($cuenta, 3, '0', STR_PAD_LEFT)."</td>";
                                $html .= "<td>".$val_emple["rubro"]."</td>";
                                $html .= "<td>".$val_emple["nombre_ubicacion"]."</td>";
                                $html .= "<td>"."</td>";
                                $html .= "<td>".$total_factura."</td>";
                                $html .= "<td>".$fecha_fin."</td>";
                                $html .= "</tr>";
                            }
                            $html .= "<tr>";
                            $html .= "<td class='colspan'>CUENTAS HABILITADAS"."</td>";
                            $html .= "</tr>";
                            ...
                            $data_empleado=fun_cliente_fechainicio($fecha_desde,$fecha_hasta);
                            $cuenta=0;
                            foreach ($data_empleado as $val_emple) {
                                ...
                                $cuenta++;
                                $fecha_fin = strtotime($val_emple["fecha_inicio"]);
                                $fecha_fin = date("d-m-Y", $fecha_fin);
                                $html .= "<tr>";
                                $html .= "<td>".str_pad($cuenta, 3, '0', STR_PAD_LEFT)."</td>";
                                $html .= "<td>".$val_emple["rubro"]."</td>";
...
<script>
    ...
    $("#exportTXT").click(function () {
            ...
            guardarComoArchivoTexto(contenidoTexto, 'INFORMES PNC BOTON INVENTARIOS RADIOS.txt');
    ...
    $("#exportPDF").click(function () {
       ...
       fontSize: 5,
        ...
        doc.save('INFORMES PNC BOTON INVENTARIOS PERSONAL.pdf');
                /* ************* */
    })
    ...
    $("#exportExcel").click(function () {
       ...
       /*  ws['!cols'][0] = { wch: 10, };
        ...
        XLSX.writeFile(wb, "REPORTE FIN DE SERVICIOS.xlsx");
