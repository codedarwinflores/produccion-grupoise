    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_asignados($fechahasta_formateada) {
            $query = "SELECT tbl_empleados.*,transacciones_agente.* FROM `transacciones_agente`,tbl_empleados where tbl_empleados.codigo_empleado=transacciones_agente.idagente_transacciones_agente and  STR_TO_DATE(fecha_transacciones_agente, '%d-%m-%Y') <= '$fechahasta_formateada' group by idagente_transacciones_agente order by transacciones_agente.id desc";
            /* echo $query; */
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
                            ...
                            foreach ($agrupado as $jefe => $jefeData) {
                                ...
                                foreach ($jefeData as $nombre_coor => $coorData) {
                                    ...
                                    foreach ($coorData['detalle'] as $ubicacion) {
                                        ...
                                        $html .= "<tr>";
                                        $html .= "<td>".$cuenta++."</td>";
                                        $html .= "<td>".$partes_asig."-".$ubicacion["codigo_ubicacion"]." ".$ubicacion["nombre_ubicacion"]."</td>";
                                        $html .= "<td>".$asig."</td>";
                                        $html .= "<td>".$auto."</td>";
                                        $html .= "<td>".$vacante."</td>";
                                        ...
                                        foreach ($data_asigna as $val_asig) {
                                            ...
                                            if($partes[0]==$ubicacion["codigo_ubicacion"]){
                                                ...
                                                $nombre_cargo=trim(trim($val_asig["primer_nombre"])." ".trim($val_asig["segundo_nombre"]).' '.trim($val_asig["tercer_nombre"]).' '.trim($val_asig["primer_apellido"]).' '.trim($val_asig["segundo_apellido"]).' '.trim($val_asig["apellido_casada"]));
                                                $nombre_cargo = preg_replace('/\s+/', ' ', $nombre_cargo);

                                                $turno_24hr=($val_asig["turno_transacciones_agente"] == "24h/r") ? "XX" : " ";
                                                $turno_12hd5=($val_asig["turno_transacciones_agente"] == "12h/d5") ? "XX" : " ";
                                                $turno_12hd6=($val_asig["turno_transacciones_agente"] == "12h/d6") ? "XX" : " ";
                                                $turno_12hn6=" ";
                                                $turno_12hd7=($val_asig["turno_transacciones_agente"] == "12h/d7") ? "XX" : " ";
                                                $turno_12hn7=($val_asig["turno_transacciones_agente"] == "12h/n7") ? "XX" : " ";
                                                $turno_Septimo=($val_asig["turno_transacciones_agente"] == "Septimo") ? "XX" : " ";
                                                $turno_Extraordinario=($val_asig["turno_transacciones_agente"] == "Extraordinario") ? "XX" : " ";


                                                $fecha_contratacion = strtotime($val_asig["fecha_contratacion"]);
                                                $fecha_contratacion = date("d-m-Y", $fecha_contratacion); 
                                                ...
                                                $html .= "<td>"."</td>";
                                                $html .= "<td>"."</td>";
                                                $html .= "<td>".$turno_24hr."</td>";/*  */
                                                $html .= "<td>".$turno_12hd5."</td>";/*  */
                                                $html .= "<td>".$turno_12hd6."</td>";/*  */
                                                $html .= "<td>".$turno_12hn6."</td>";/*  */
                                                $html .= "<td>".$turno_12hd7."</td>";/*  */
                                                $html .= "<td>".$turno_12hn7."</td>";/*  */
                                                $html .= "<td>".$turno_Septimo."</td>";/*  */
                                                $html .= "<td>".$turno_Extraordinario."</td>";/*  */
                                                $html .= "<td>".$fecha_contratacion."</td>";
                                                $html .= "<td>".$val_asig["fecha_movimiento_transacciones_agente"]."</td>";
                                                $html .= "<td>"."</td>";
