    ...
    <div class="box">
      ...
      <div class="table-responsive">
                <table  class="table table-bordered table-striped dt-responsive tablas" width="100%" id="tabladatos">
                    <thead>
                        <tr>
                            <th colspan="13">LISTADO DE EMPLEADOS DATOS PENDIENTES</th>
                        </tr>
                        <tr>
                            <th colspan="13"></th>
                        </tr>
                        ...
                        <?php
                            ...
                            foreach ($data_depa as $val_depa) { 
                                ...
                                foreach ($data_empleado as $val_empleado) { 
                                    ...
                                    $html.="<td>".$val_empleado["numero_isss"]."</td>";
                                    $html.="<td>".$val_empleado["numero_cuenta"]."</td>";
                                    $html.="<td>".$val_empleado["codigo_afp"]."</td>";
                                    $html.="<td>".$val_empleado["nup"]."</td>";
                                    $html.="<td>".$val_empleado["documento_identidad"]." ".$val_empleado["numero_documento_identidad"]."</td>";
                                    $html.="<td>".$certificado."</td>";
                                    $html.="<td>".$val_empleado["sueldo"]."</td>";
                                    $html.="<td>".$val_empleado["anticipo"]."</td>";
                                    $html.="<td>".$devengofijo."</td>";
                                    $html.="<td>".$infocargo."</td>";
                                    $html.="<td>".$val_empleado["fecha_contratacion"]."</td>";
                                    $html.="</tr>";
                                }
...
<script>
    ...
    $("#exportTXT").click(function () {
            ...
            guardarComoArchivoTexto(contenidoTexto, 'LISTADO DE EMPLEADOS DATOS PENDIENTES.txt');
    ...
    $("#exportPDF").click(function () {
       ...
       fontSize: 5,
        ...
        doc.save('LISTADO DE EMPLEADOS DATOS PENDIENTES.pdf');
                /* ************* */
    })
    ...
    $("#exportExcel").click(function () {
        ...
        XLSX.writeFile(wb, "LISTADO DE EMPLEADOS DATOS PENDIENTES.xlsx");
