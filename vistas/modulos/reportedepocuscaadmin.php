                                ...
                                <tr>
                                    <!-- a depositar -->
                                        <td>
                                             ...
                                             $deposito_admin=floatval($row_data_planilla_admin["total_liquidado_planilladevengo".$cambio_table.""])-$valodevengono_grabado;
                                                $total_global+=bcdiv($deposito_admin,'1', 2);
                                                 echo  trim(bcdiv($deposito_admin,'1', 2))." ";
                                             ?>
                                       </td>
                                         <!-- cuenta -->
