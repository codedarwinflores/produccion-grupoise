                    ...
                    <tbody> 
                        <?php
                            ...
                            foreach ($array_ubicacion as $ubicacion) {
                                ...
                                if (!isset($agrupado[$cliente_ori])) {
                                    $agrupado[$cliente_ori] = array();
                                }
                                ...
                                if (!isset($agrupado[$cliente_ori][$nombre_ubicacion])) {
                                    $agrupado[$cliente_ori][$nombre_ubicacion] = array(
                                ...
                                $agrupado[$cliente_ori][$nombre_ubicacion]['detalle'][] = $ubicacion;
                                $agrupado[$cliente_ori][$nombre_ubicacion]['total'] += $total;
                            ...
                            foreach ($agrupado as $cliente_ori => $clienteData) {
                                $html .= "<tr>";
                                $html .= "<td class='colspan'>CLIENTE " . $cliente_ori . "</td>";
                                $html .= "</tr>";
                                        ...
                                        $html .= "<td >" . "</td>";
                                        $html .= "<td >" . "</td>";
                                        $html .= "<td >" .$aut_empresa. "</td>";
                                        $html .= "<td >" .$fact_empresa. "</td>";
                                        $html .= "<td >" .$afact_empresa. "</td>";
                                        $html .= "<td >"  . "</td>";
                                        $html .= "<td >" . "</td>";
