  ...
  <section class="content">
    ...
    <div class="box">
     ...
     <a href='todosreportes' class="btn btn-danger">
      ...
      <div class="col-md-6" >
        <h4>NOMBRE DEL PATRONO  INVESTIGACIONES Y SEGURIDAD S.A. DE C.V.   </h4>
        <h5>DIRECCION  Col.San Francisco Av. Las Buganvillas # 7M     </h5>
        <h5>TELEFONO  2245-1900 </h5>
        <h5>ACTIVIDAD ECONOMICA Servicios De Seguridad </h5>
      </div>
      <div class="col-md-6" >
        <h5>FECHA    <?php echo $fechaActual ?></h5>
        <h5>NIT      0614-121093-101-0 - pendiente</h5>
        <h5> PLANILLA DEL <?php echo $fecha_planilla_desde." AL ".$fecha_planilla_hasta?></h5>
        <h5> PERIODO DE PAGO  09/2022 - pendiente</h5>
        <h5> NUMERO PATRONAL 701940021 - pendiente</h5>
      </div>
                ...
                <table  class="table table-bordered table-striped dt-responsive tablas" width="100%">
                    <thead>
                        <tr>
                            <th>CORR.</th>
                            <th># ISSS</th>
                            <th>NOMBRE SEGUN TARJETA DE AFILIACION</th>
                            <th> SALARIO</th>
                            <th>ADICIONAL</th>
                            <th>VACACION</th>
                            <th>REM</th>
                    ...
                    ?>                
                                ...
                                <tr>
                                    ...
                                    <?php if($row_empleado["descontar_isss"]=="Si")
                                        {
                                    ?>
                                    ...
                                    ?>
                                        <td><?php echo $row_empleado["descontar_isss"]?></td>
                                    <?php
                                        }
                                    ?>

                                    <td><?php echo $row_empleado["nombre_segun_isss"]?></td>
                                    <td><?php echo $row_empleado["sueldo"]?></td>
                                    <?php
                                     $data_devengos = devengos($idempleado);
                                     foreach($data_devengos as $row_devengo) {
                                    ?>
                                        <td><?php echo $row_devengo["sumavalor"]?></td>
                                    <?php
                                        }
                                    ?>
