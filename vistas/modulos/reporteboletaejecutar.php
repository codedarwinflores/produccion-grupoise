  ...
  <section class="content">
    ...
    <div class="box">
     ...
     <a href='todosreportes' class="btn btn-danger">
      ...
      <a href="ajax/BOLETA OPCION EJECUTAR.txt" download="BOLETA OPCION EJECUTAR.txt" id="descargar_txt" ></a>
      <a href="ajax/BOLETA OPCION EJECUTAR.pdf" download="BOLETA OPCION EJECUTAR.pdf" id="descargar_pdf" ></a>
      ...
      <?php
        ...
        function devengos($idempleado1,$numero,$devengos_table) {
            $query = "SELECT SUM(valor_devengo_planilla) as sumadevengo FROM tbl_devengo_descuento_planilla".$devengos_table." where  idempleado_devengo='$idempleado1' and codigo_planilla_devengo='$numero' and isss_devengo_devengo_descuento_planilla='No' and afp_devengo_devengo_descuento_planilla='No' and renta_devengo_devengo_descuento_planilla='No' and tipo_valor like'%suma%'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
        ...
        function devengos_contodo($idempleado1,$numero,$devengos_table) {
            $query = "SELECT SUM(valor_devengo_planilla) as sumadevengo FROM tbl_devengo_descuento_planilla".$devengos_table." where  idempleado_devengo='$idempleado1' and (codigo_planilla_devengo='$numero' and isss_devengo_devengo_descuento_planilla='Si') or (codigo_planilla_devengo='$numero' and afp_devengo_devengo_descuento_planilla='Si') or (codigo_planilla_devengo='$numero' and renta_devengo_devengo_descuento_planilla='Si') and tipo_valor like'%suma%'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
        function devengos_norestrinccion($id,$tipo,$devengos_table) {
            $query = "SELECT * FROM tbl_devengo_descuento_planilla".$devengos_table." where  id='$id' and tipo_valor like'%$tipo%'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
        function descuentos_norestrinccion($id,$tipo,$devengos_table) {
            $query = "SELECT * FROM tbl_devengo_descuento_planilla".$devengos_table." where  id='$id' and tipo_valor like'%$tipo%'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
        function devengos_table($idempleado1,$numero,$devengos_table) {
            $query = "SELECT * FROM tbl_devengo_descuento_planilla".$devengos_table." where  idempleado_devengo='$idempleado1' and codigo_planilla_devengo='$numero'";
                ...
                <table  class="table table-bordered table-striped dt-responsive tablas" width="100%" id="tabladatos">
                    ...
                    ?>                
                            ...
                            <tbody>
                                ...
                                <?php
                                    $devengos_table_fun=devengos_table($idempleado,$numero,$devengos_table);
                                    $datosCategoria1 = [];
                                    $datosCategoria2 = [];
                                        // Separar los datos en dos arreglos según la categoría
                                        foreach ($devengos_table_fun as $row_devengos_maestra) {
...
<script>
    ...
    $("#exportExcel").click(function () {
        ...
        XLSX.writeFile(wb, "BOLETA OPCION EJECUTAR.xlsx");
        location.reload();
