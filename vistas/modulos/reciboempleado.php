...
<div id="modalAgregarrecibo" class="modal fade reciboempleados0" role="dialog"  data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title titulo_modulo"><!-- Agregar <?php echo $Nombre_del_Modulo;?> --></h4>
            ...
            <div class="form-group   gruporecibo_descuento_recibo" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <select class="form-control input-lg input_descuento_recibo mi-selector" name="nuevodescuento_recibo" id="nuevodescuento_recibo" placeholder="" value="" autocomplete="off" required="">
                  ...
                  function descuentos()
                  {
                        $query01 = "SELECT `id`, `codigo`, `descripcion`, `porcentaje`, `tipo`, `cargo_abono`, `cuenta_contable`, `isss_devengo`, `afp_devengo`, `renta_devengo` FROM `tbl_devengo_descuento` WHERE tipo='-Resta' and codigo='0017'";
                        $sql = Conexion::conectar()->prepare($query01);
                        $sql->execute();
                        return $sql->fetchAll();
                  }
        ...
        <div class="modal-footer">
          ...
          <a href="empleados" class="btn btn-danger pull-left">Volver</a>
