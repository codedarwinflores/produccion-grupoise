...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <a href="transancionkardex" class="btn btn-danger"> Volver</a>
      ...
      <div class="row">
        ...
        function infokardex($correlativo_kardex1)
        {
              ...
              FROM historial_kardex,tbl_clientes_ubicaciones where tbl_clientes_ubicaciones.id=historial_kardex.ubicacion_kardexh and correlativo_kardexh='$correlativo_kardex1' group by correlativo_kardexh";
      ...
      <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
         ...
         <?php
            function kardex($equipo)
            {
                  ...
                  where historial_kardex.transancion_kardexh=tbl_transacciones_equipo.id and historial_kardex.equipo_kardexh=tbl_otros_equipos.codigo_equipo and historial_kardex.ubicacion_kardexh= tbl_clientes_ubicaciones.id and historial_kardex.correlativo_kardexh='$equipo'";
                  $sql = Conexion::conectar()->prepare($query01);
                  $sql->execute();
                  return $sql->fetchAll();
            }
