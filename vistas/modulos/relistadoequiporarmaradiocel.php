  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_celular_tipo($codigo)
                  {
        ...
        function fun_celular($codigo,$grupo)
                  {
        ...
        $equipo = "arma";
            ...
            $condicion="tipoequipo ='arma' or tipoequipo ='radio' or tipoequipo ='celular'";
    ...
    /*     $fecha_desde = strtotime($fechadesde);
      ...
      <input type="hidden" class="titulo_reportes" value="REPORTE ARMAS RADIOS Y CELULAR">
                    ...
                    <tbody> 
                        <?php
                            ...
                            foreach ($array_datos as $ubicacion) {
                                ...
                                /* celular */
                                $data_tipo_arma=fun_celular_tipo($codigo);
                                foreach ($data_tipo_arma as $valtipo) {
                                ...
                                foreach ($jefeData as $nombre_coor => $coorData) {
                                    ...
                                    foreach ($coorData as $nombre_ubi => $ubiData) {
                                        ...
                                        foreach ($tipoData['detalles'] as $ubicacion_detalle) {
                                                ...
                                                /* celular */
                                                $data_arma=fun_celular($codigo,$id_tipo);
                                                foreach ($data_arma as $val_arma) {
                                                    $html .= "<tr>";
