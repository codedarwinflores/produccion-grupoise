  ...
  <section class="content">
    ...
    <div class="box">
      ...
      /* $banco_value=""; */
        ...
        function devengos_nograbados($idempleado1,$numero,$devengos_table_maestra) {
            $query = "SELECT SUM(valor_devengo_planilla) AS sumadevengo, idempleado_devengo
            FROM tbl_devengo_descuento_planilla".$devengos_table_maestra."
            WHERE
                idempleado_devengo = '$idempleado1'
                AND (
                    (codigo_planilla_devengo='$numero' AND isss_devengo_devengo_descuento_planilla = 'No')
                    AND
                    (codigo_planilla_devengo='$numero' AND afp_devengo_devengo_descuento_planilla = 'No')
                    AND
                    (codigo_planilla_devengo='$numero' AND renta_devengo_devengo_descuento_planilla = 'No')
                )
                AND tipo_valor LIKE '%suma%'
            GROUP BY idempleado_devengo";
      ...
      <div class="table-responsive">
                <table  class="table table-bordered table-striped dt-responsive " width="100%" id="tabladatos">
                    ...
                    ?>                
                                ...
                                <tr>
                                    ...
                                    /* if($row_data_planilla_admin["descuento_isss_planilladevengo".$cambio_table.""]=="0"){ */
                                        ...
                                        $data_devengos = devengos_nograbados($idempleado,$numero,$devengos_table_maestra);
                                        $sumadevengo=0;
                    ...
                    <tr>
                        ...
                        ?>
                        <?php
                            $data_sumaglobal = suma_planilla_admin_data($numero,$cambio_table,$cambio_table);
