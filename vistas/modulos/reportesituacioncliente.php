  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php
        ...
        function cliente($id) {
            $query = "SELECT clientes.*,tbl_clientes_ubicaciones.nombre_ubicacion as nombreubi FROM clientes,tbl_clientes_ubicaciones where id_cliente=clientes.id and tbl_clientes_ubicaciones.codigo_ubicacion='$id'";
            /* echo $query; */
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
                    ...
                    <tbody> 
                        <?php
                            ...
                            foreach ($data_maestra as  $val_maestra) {
                                ...
                                $array_motivos[]=array("motivo"=>$valor_motivo,"cliente"=>$nombre_cliente,"fecha"=>$fecha,"nombre_completo"=>$nombre_completo,"horas_extras"=>$horas_extras,"valor_hora_extra_empleado"=>$valor_hora_extra_empleado,"nombre_ubicacion"=>$nombre_ubicacion,"id"=>$id_situ);
                            ...
                            foreach ($datos_agrupados as $motivo => $grupo) {
                                $html.="<tr>";
                                $html.="<td colspan='5'>INVESTIGACIONES Y SEGURIDAD S.A. DE C.V."."</td>";
                                $html.="</tr>";

                                $html.="<tr>";
                                $html.="<td colspan='5'> *** REPORTE DE HORAS EXTRAS ***  "."</td>";
                                $html.="</tr>";

                                $html.="<tr>";
                                $html.="<td colspan='5'>".$fecha_desde." ".$fecha_hasta." "."</td>";
                                $html.="</tr>";

                                $html.="<tr>";
                                $html.="<td colspan='5'>MOTIVO:".$motivo."</td>";
                                $html.="</tr>";
                                foreach ($grupo as $item) {
                                    $html.="<tr>";
                                    $html.="<td colspan='5'>CLIENTE:".$item["cliente"]."</td>";
                                    $html.="</tr>";

                                    $html.="<tr>";
                                    $html.="<td>FECHA."."</td>";/* 1 */
                                    $html.="<td>AGENTE"."</td>";/* 2 */
                                    $html.="<td>H.EXTRAS"."</td>";/* 2 */
                                    $html.="<td>VALOR"."</td>";/* 4 */
                                    $html.="<td>LUGAR DONDE SE PRESTO EL SERVICIO"."</td>";/* 5 */
                                    $html.="</tr>";


                                    foreach ($array_motivos as $item_completo) {

                                        if($item_completo["motivo"]==$motivo && $item_completo["cliente"]==$item["cliente"]){
                                            ...
                                            $html.="<tr>";
                                            $html.="<td>".$item_completo["fecha"]."</td>";
                                            $html.="<td>".$item_completo["nombre_completo"]."</td>";
                                            $html.="<td>".$item_completo["horas_extras"]."</td>";
                                            $html.="<td>".$item_completo["valor_hora_extra_empleado"]."</td>";
                                            $html.="<td>".$item_completo["nombre_ubicacion"]."</td>";
                                            $html.="</tr>";
                                    ...
                                    $html.="<td>"."</td>";
                                    $html.="<td>"."</td>";
                                    $html.="<td>".bcdiv($horas_grobal,'1', 2)."</td>";
                                    $html.="<td>".bcdiv($valor_horas_grobal,'1', 2)."</td>";
                                    $html.="<td>"."</td>";
                                    $html.="</tr>";
                                    $horas_grobal=0;
                                    $valor_horas_grobal=0;
                            ...
                            $html.="<tr>";
                            $html.="<td colspan='5'>RESUMEN DE HORAS EXTRAS"."</td>";
                            $html.="</tr>";
