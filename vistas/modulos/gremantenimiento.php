        ...
        <div class="row">
                ...
                <div class="col-md-12">
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <select name="" id="tiporeporte" class="form-control">
                                    ...
                                    <option value="repomantenimiento">REPORTE MANTENIMIENTOS</option>
                                    <option value="repomantenimientotipo">REPORTE MANTENIMIENTOS ORDENADO POR TIPO</option>
                                    <option value="repomantenimientototal">REPORTE TOTALES</option>
                                    <option value="repomantenimientonove">REPORTE NOVEDADES</option>
                                    <option value="repocontrolflota">REPORTE CONTROL DE FLOTA</option>
                            ...
                            <div class="col-md-12 " >
                              ...
                              <div class="col-md-4 oculta_equipo">
                                ...
                                <div class="col-md-12 oculta_equipo">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Seleccionar Vehiculo</label>
                                            <select name="vehiculo" id="vehiculo" class="form-control mi-selector " >
                                              ...
                                              <?php
                                                function vehi() {
                                                  ...
                                                  echo "<option value=".$value["id"].">".$value["placa"]."-".$value["descripcion_vehiculo"]."</option>";
                                                  }
                                              ?>
                                            </select>
                                        </div>
