  ...
  <section class="content">
    ...
    <div class="box">
     ...
     <a href='todosreportes' class="btn btn-danger">
      ...
      <a href="ajax/BOLETA OPCION SUPERVISOR.txt" download="BOLETA OPCION SUPERVISOR.txt" id="descargar_txt" ></a>
      <a href="ajax/BOLETA OPCION SUPERVISOR.pdf" download="BOLETA OPCION SUPERVISOR.pdf" id="descargar_pdf" ></a>
      ...
      $devengos_maestra_table=$_POST["devengos_table"];
      ...
      if($tipoplanilla=="planilladevengo_anticipo"){
        ...
        /* solo ubicacion de coordinador */
        function ubicacion_coordinador($coordinador) {
            $query = "SELECT tbl_ubicaciones_agentes_asignados.*, tbl_clientes_ubicaciones.*, tbl_empleados.* , tbl_empleados.id as id
                      FROM tbl_clientes_ubicaciones,`tbl_ubicaciones_agentes_asignados`,tbl_empleados
                      where  tbl_ubicaciones_agentes_asignados.idubicacion_agente=tbl_clientes_ubicaciones.id and 
                             codigo_agente=tbl_empleados.codigo_empleado and
                             tbl_clientes_ubicaciones.id_coordinador_zona='$coordinador'";
        ...
        function devengos($idempleado1,$numero,$devengos_maestra_table) {
            $query = "SELECT SUM(valor_devengo_planilla) as sumadevengo FROM tbl_devengo_descuento_planilla".$devengos_maestra_table." where  idempleado_devengo='$idempleado1' and codigo_planilla_devengo='$numero' and isss_devengo_devengo_descuento_planilla='No' and afp_devengo_devengo_descuento_planilla='No' and renta_devengo_devengo_descuento_planilla='No' and tipo_valor like'%suma%'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };

        function devengos_contodo($idempleado1,$numero,$devengos_maestra_table) {
            $query = "SELECT SUM(valor_devengo_planilla) as sumadevengo FROM tbl_devengo_descuento_planilla".$devengos_maestra_table." where  idempleado_devengo='$idempleado1' and (codigo_planilla_devengo='$numero' and isss_devengo_devengo_descuento_planilla='Si') or (codigo_planilla_devengo='$numero' and afp_devengo_devengo_descuento_planilla='Si') or (codigo_planilla_devengo='$numero' and renta_devengo_devengo_descuento_planilla='Si') and tipo_valor like'%suma%'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
        function devengos_norestrinccion($id,$tipo,$devengos_maestra_table) {
            $query = "SELECT * FROM tbl_devengo_descuento_planilla".$devengos_maestra_table." where  id='$id' and tipo_valor like'%$tipo%'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
        function descuentos_norestrinccion($id,$tipo,$devengos_maestra_table) {
            $query = "SELECT * FROM tbl_devengo_descuento_planilla".$devengos_maestra_table." where  id='$id' and tipo_valor like'%$tipo%'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
        function devengos_table($idempleado1,$numero,$devengos_maestra_table) {
            $query = "SELECT * FROM tbl_devengo_descuento_planilla".$devengos_maestra_table." where  idempleado_devengo='$idempleado1' and codigo_planilla_devengo='$numero'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
        ...
        function empleado_supervisor() {
            ...
            function empleado_supervisor_id($id) {
                $query = "SELECT tbl_empleados.id as idempleado, tbl_empleados.* FROM tbl_empleados
                INNER JOIN cargos_desempenados 
                WHERE tbl_empleados.nivel_cargo = cargos_desempenados.id AND  cargos_desempenados.descripcion='COORDINADOR DE ZONA' and tbl_empleados.id=$id";
      ...
      <div class="table-responsive">
                <table  class="table table-bordered table-striped dt-responsive tablas" width="100%" id="tabladatos">
                  ...
                  $data_maestra = empleado_supervisor();
                  if($idempleadoinput=="*"){
                    $data_maestra = empleado_supervisor();
                  }
                  else{
                  $data_maestra = empleado_supervisor_id($idempleadoinput);
                  }
                  foreach($data_maestra as $val_supervisor) {
                    $idempleadoinput=$val_supervisor["id"];

                    $data_ubi_coor=ubicacion_coordinador($idempleadoinput);
                    $contar_ubicacion=1;
                    foreach($data_ubi_coor as $row_ubi_coor) {
                        $idcoordinado=$row_ubi_coor["id"];
                        $contar_ubicacion++;
                  ?>
                    <thead>
                            <tr>
                    ...
                    <tbody>
                        ...
                        $cuenta=0;
                        $data_planilla_admin = planilla_admin($numero,$idcoordinado,$cambio_table);
                        $depositar_global=0;
                        $efectivo_global=0;
                        ...
                        ?>                
                                ...
                                <tr>
                                    ...
                                    <td>Sueldo</td>
                                    <td>
                                        <?php echo bcdiv($row_data_planilla_admin["dias_trabajo_planilladevengo".$cambio_table.""] ,'1', 2);?>
                                    </td>
                                    <td>
                                        <?php 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                             $total_global+=bcdiv($row_data_planilla_admin["hora_extra_diurna_planilladevengo".$cambio_table.""] ,'1', 2);
                                            echo bcdiv($row_data_planilla_admin["hora_extra_diurna_planilladevengo".$cambio_table.""] ,'1', 2)
                                         ?>
                                    </td>
                                    <!-- descuentos -->
                                ...
                                <tr>
                                    <td>Extras Nocturas</td>
                                    <td></td>
                                    <td>
                                         <?php 
                                            $total_global+=bcdiv($row_data_planilla_admin["hora_extra_nocturna_planilladevengo".$cambio_table.""] ,'1', 2);
                                             echo bcdiv($row_data_planilla_admin["hora_extra_nocturna_planilladevengo".$cambio_table.""] ,'1', 2)?>
                                    </td>
                                ...
                                <tr>
                                    <td>Extras Domingo Diurnas</td>
                                    <td></td>
                                    <td>
                                         <?php 
                                            $total_global+=bcdiv($row_data_planilla_admin["hora_extra_domingo_planilladevengo".$cambio_table.""] ,'1', 2);
                                            echo bcdiv($row_data_planilla_admin["hora_extra_domingo_planilladevengo".$cambio_table.""] ,'1', 2)?>
                                    </td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                ...
                                <tr>
                                    <td>Extras Domingo Nocturnas</td>
                                    <td></td>
                                    <td>
                                         <?php 
                                            $total_global+=bcdiv($row_data_planilla_admin["hora_extra_domingo_nocturna_planilladevengo".$cambio_table.""] ,'1', 2);
                                         echo bcdiv($row_data_planilla_admin["hora_extra_domingo_nocturna_planilladevengo".$cambio_table.""] ,'1', 2)?>
                                    </td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                ...
                                <?php
                                    $devengos_table=devengos_table($idempleado,$numero,$devengos_maestra_table);
                                    $datosCategoria1 = [];
                                    $datosCategoria2 = [];
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        $ <?php echo $total_descuento_global?>
                                    </td>
                    ...
                    <?php
                        } /* fin de  foreach planilla*/
                        ?>
                    </tbody>
                <?php
                }/* fin de foreach ubicacion */
            }/* fin foreach supervizor */
                ?>
          </table>
        </div> 
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            url: "ajax/pdf_txt_boletasupervisor.php", // Cambia esto por la URL del script PHP en tu servidor
    ...
    $("#exportExcel").click(function () {
        ...
        XLSX.writeFile(wb, "BOLETA OPCION SUPERVISOR.xlsx");
        location.reload();
