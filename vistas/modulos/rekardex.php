  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_kardex($fechadesde,$fechahasta,$condicion,$condicion2) {
            ...
            fecha_kardex <= '$fechahasta' $condicion $condicion2";  
        ...
        if($kardex!="*"){
            $condicion="and kardex.id=".$kardex;
        }

        if($nuevo_usado!="*"){
            $condicion2="and tbl_otros_equipos.descripcion like '%".$nuevo_usado."%'";
        }
    ...
    /*     $fecha_desde = strtotime($fechadesde);
      ...
      <input type="hidden" class="titulo_reportes" value="REPORTE KARDEX">
                ...
                <table  class="table table-bordered table-striped dt-responsive" width="100%" id="tabladatos">
                    ...
                    <tbody> 
                        <?php
                            ...
                            $data_kardex=fun_kardex($fechadesde,$fechahasta,$condicion,$condicion2);
                            $cuenta=0;
                            foreach ($data_kardex as $val_kardex) {
                                $cantidad_salida=0;
                                $cantidad_entrada=0;
                                $codigo_quipo=$val_kardex["codigo_equipo"];
                                $cantidad_kardex=$val_kardex["cantidad_kardex"];
                                $precio_kardex=$val_kardex["precio_kardex"];
                                $total_kardex=$val_kardex["total_kardex"];

                                $inicial=0;
                                $data_kardex_his_limit=fun_kardex_his_limit($codigo_quipo,$fechadesde,$fechahasta);
                                foreach ($data_kardex_his_limit as $subvalue) {
                                    $inicial=$subvalue["cantidad_kardexh"];
                                }


                                $data_kardex_his=fun_kardex_his($codigo_quipo,$fechadesde,$fechahasta);
                                foreach ($data_kardex_his as $val_his) {
                                ...
                                $html .= "<tr>";
                                $html .= "<td>".$val_kardex["codigo_equipo"]."</td>";
                                $html .= "<td>".$val_kardex["descripcion"]."</td>";
                                $html .= "<td>0.00"."</td>";
                                $html .= "<td>".$inicial."</td>";
                                $html .= "<td>".$cantidad_entrada."</td>";
                                $html .= "<td>".$cantidad_salida."</td>";
                                $html .= "<td>".$cantidad_kardex."</td>";
                                $html .= "<td>".$precio_kardex."</td>";
                                $html .= "<td>".$total_kardex."</td>";
                                $html .= "</tr>";
