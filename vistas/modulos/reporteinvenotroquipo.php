    ...
    <div class="box">
      ...
      <?php
        ...
        function otroquipos($operador) {
            $query = "SELECT * FROM tbl_otros_equipos $operador";
        ...
        function tipo_equipos($tipoarma) {
            $query = "SELECT * FROM tipo_otros_equipos $tipoarma";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
                    ...
                    <tbody> 
                        <?php
                            ...
                            foreach ($data_maestra as $val_maestra) { 
                                ...
                                $id_tipo="WHERE tipo_equipos='".$val_maestra["id"]."'";
                                
                                $html.="<tr>";
                                $html.="<td colspan='9'>TIPO DE EQUIPO : ".$val_maestra["nombre"]."</td>";
                                $html.="</tr>";  
                                ...
                                /* $fechaNueva = date("d-m-Y", strtotime($val_arma["fecha_vencimiento"])); */
                                    ...
                                    $html.="<tr>";
                                    $html.="<td>".$correlativo++." ".$val_arma["descripcion"]."</td>";
                                    $html.="<td>"."</td>";
                                    $html.="<td>"."</td>";
                                    $html.="<td>"."</td>";
                                    $html.="<td>"."</td>";
