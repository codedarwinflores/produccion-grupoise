      ...
      <!-- ****** -->
          ...
          <div class="form-group ubicacion_retiro  gruporetiro_ubicacion_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="text" class="form-control input-lg input_ubicacion_retiro" name="nuevoubicacion_retiro" placeholder="" value="1" autocomplete="off" required="">
          ...
          <div class="form-group fecha_contratacion_retiro  gruporetiro_fecha_contratacion_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="text" class="form-control input-lg input_fecha_contratacion_retiro" name="nuevofecha_contratacion_retiro" placeholder="" value="1" autocomplete="off" required="">
          ...
          <div class="form-group horas_extras_pentientes_retiro  gruporetiro_horas_extras_pentientes_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="number" class="form-control input-lg input_horas_extras_pentientes_retiro" name="nuevohoras_extras_pentientes_retiro" placeholder="" value="1" autocomplete="off" required="">
          ...
          <div class="form-group horas_llegadas_tardes_retiro  gruporetiro_horas_llegadas_tardes_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="number" class="form-control input-lg input_horas_llegadas_tardes_retiro" name="nuevohoras_llegadas_tardes_retiro" placeholder="" value="1" autocomplete="off" required="">
          ...
          <div class="form-group descuento_tarde_retiro  gruporetiro_descuento_tarde_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="number" class="form-control input-lg input_descuento_tarde_retiro" name="nuevodescuento_tarde_retiro" placeholder="" value="1" autocomplete="off" required="">
          ...
          <div class="form-group observaciones_retiro  gruporetiro_observaciones_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="text" class="form-control input-lg input_observaciones_retiro" name="nuevoobservaciones_retiro" placeholder="" value="1" autocomplete="off" required="">
