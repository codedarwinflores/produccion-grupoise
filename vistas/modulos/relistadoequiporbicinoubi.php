 ...
 ?>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_tipo($codigo)
                  {
                        $query01 = "SELECT tbl_tipos_bicicleta.*,tbl_tipos_bicicleta.id as idtipo 
                        FROM tbl_bicicleta,tbl_tipos_bicicleta 
                        where tbl_tipos_bicicleta.id=tbl_bicicleta.id_tipo_bicicleta and 
                        tbl_bicicleta.codigo_bicicleta='$codigo' group by tbl_bicicleta.id_tipo_bicicleta";
        ...
        function fun_equipo($codigo,$grupo)
                  {
                        $query01 = "SELECT * FROM tbl_bicicleta where codigo_bicicleta='$codigo' and id_tipo_bicicleta='$grupo' ";
        ...
        $condicion="tipoequipo ='bicicleta'";
    ...
    /*     $fecha_desde = strtotime($fechadesde);
      ...
      <input type="hidden" class="titulo_reportes" value="REPORTE BICICLETA">
                                    ...
                                    foreach ($coorData as $nombre_ubi => $ubiData) {
                                        ...
                                        foreach ($tipoData['detalles'] as $ubicacion_detalle) {
                                                ...
                                                foreach ($data_arma as $val_arma) {
                                                    ...
                                                    $html .= "<td>1"."</td>";
                                                    $html .= "<td>".$val_arma["descripcion_bicicleta"]."</td>";
                                                    $html .= "<td>"."</td>";
                                                    $html .= "<td>"."</td>";
                                                    $html .= "<td>".$val_arma["numero_serie"]."</td>";
                                                    $html .= "<td>".$val_arma["estado_bicicleta"]."</td>";
                                                    $html .= "</tr>";
                                                }/* arma */
