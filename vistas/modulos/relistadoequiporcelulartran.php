    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_tra_equipo_actual($fecha, $condicion) {
            ...
            ) and STR_TO_DATE(fecha_movimiento_his, '%d-%m-%Y') <= STR_TO_DATE('$fecha', '%d-%m-%Y') and tipoequipo_his='celular' $condicion
                        ...
                        <?php
                            ...
                            foreach ($data_movi_his as $va_movi) {
                                ...
                                foreach ($data_arma as $val_arma) {
                                    $nom_celular=$val_arma["descripcion"];
                                    $matri_celular=""/* $val_arma["numero_matricula"] */;
                                    $venci_celular=""/* $val_arma["fecha_vencimiento"] */;
                                    $serie_celular=$val_arma["serie_celular"];
                                }
                                ...
                                $venci_celular = strtotime($venci_celular);
                                $venci_celular = date("d-m-Y", $venci_celular);

                                $html .= "<tr>";
                                $html .= "<td>".$cadena_con_ceros."</td>";
                                $html .= "<td>".$va_movi["fecha_ingreso_movimiento_his"]."</td>";
                                $html .= "<td>".$va_movi["fecha_movimiento_his"]."</td>";
                                $html .= "<td>".$nom_celular."</td>";
                                $html .= "<td>".$matri_celular."</td>";
                                $html .= "<td>".$venci_celular."</td>";
                                $html .= "<td>".$serie_celular."</td>";
