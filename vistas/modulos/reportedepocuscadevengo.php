  ...
  <section class="content">
    ...
    <div class="box">
     ...
     <a href='todosreportes' class="btn btn-danger">
      ...
      <a href="ajax/BANCO CUSCATLAN.txt" download="BANCO CUSCATLAN.txt" id="descargar_txt" ></a>
      ...
      <div class="table-responsive">
                <table  class="table table-bordered table-striped dt-responsive tablas" width="100%" id="tabladatos">
                                ...
                                <tr>
                                    <!-- a depositar -->
                                        <td>
                                         ...
                                         <!-- cuenta -->
                                        <td><?php echo trim(str_replace("-", "", $row_empleado["numero_cuenta"]))."       4      "?></td>
                                        <!-- EMPLEADO NOMBRE -->
                    ...
                    <tr>
                        ...
                        <td>SON</td>
                        <td><?php echo trim($correlativo)." EMPLEADOS";?></td>
                    </tr>
            </tbody>
          </table>
        </div> 
...
<script>
  ...
  //Código que se ejecutará al cargar la página
    ...
    $("#exportTXT").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "ajax/pdf_txt_depocusca.php", // Cambia esto por la URL del script PHP en tu servidor
            data: { tableData: data },
