           ...
           ?>
            <div class="form-group <?php echo $row['Field'];?>">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg input_<?php echo $row['Field'];?>" name="nuevo<?php echo $row['Field'];?>" placeholder="" value="" tabla_validar="servicios_prestados" item_validar="codigo">
