    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_mantenimiento_grupo($fecha_desde, $fecha_hasta, $condicion) {
            ...
            WHERE fecha BETWEEN '$fecha_desde' AND '$fecha_hasta' $condicion group by idreparacion_mvehi";/* 2023-12-31 formato fecha */  
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
        
        function fun_mantenimiento($fecha_desde, $fecha_hasta, $id_mante) {
            $query = "SELECT * FROM mante_vehiculo
            WHERE fecha BETWEEN '$fecha_desde' AND '$fecha_hasta' and idreparacion_mvehi= '$id_mante'";/* 2023-12-31 formato fecha */  
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
        ...
        function fun_repara($id_repara) {
            ...
            WHERE id= '$id_repara'";/* 2023-12-31 formato fecha */  
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
      ...
      <input type="hidden" class="titulo_reportes" value="REPORTE MANTENIMIENTOS DE VEHICULOS">
      ...
      <div class="table-responsive">
                <table  class="table table-bordered table-striped dt-responsive" width="100%" id="tabladatos">
                    <thead>
                        ...
                        <tr>
                            <th class="colspan">*** MANTENIMIENTOS DE VEHICULOS ***</th>
                        </tr>
                        <tr>
                    ...
                    <tbody> 
                        <?php
                            ...
                            foreach ($data_mante as $val_mante) {
                                $id_vehiculo=$val_mante["idvehiculo_mante"];
                                $id_empleado=$val_mante["idempleado_mvehi"];
                                $id_repara=$val_mante["idreparacion_mvehi"];
                                ...
                                $html .= "<tr>";
                                $html .= "<td class='colspan'>TIPO DE REPARACION ".$nombre_repara."</td>";
                                $html .= "</tr>";
                                    
                                $data_fetalle=fun_mantenimiento($fecha_desde_for, $fecha_hasta_for,$id_repara);
                                $valor_total=0;
                                foreach ($data_fetalle as $val_detalle) {

                                    

                                    $idtaller=$val_detalle["id_taller"];
                                    $data_taller=fun_taller($idtaller);
                                    $nom_taller="";
                                    foreach ($data_taller as $val_taller) {
                                        $nom_taller=$val_taller["nombre_talleres"];
                                    }
                                    ...
                                    $valor_total+=$val_detalle["valor_mvehi"];
                                    $html .= "<tr>";
                                    $html .= "<td>".$val_detalle["fecha"]."</td>";
                                    $html .= "<td>".$placa_vehi."</td>";
                                    $html .= "<td>".$val_detalle["diagnostico_mvehi"]."</td>";
                                    $html .= "<td>".$nombre_cargo."</td>";
                                    $html .= "<td>".$val_detalle["kilometraje_mvehi"]."</td>";
                                    $html .= "<td>".$nom_taller."</td>";
                                    $html .= "<td>".$val_detalle["fecha_pago_mvehi"]."</td>";
                                    $html .= "<td>".$val_detalle["fecha_ingreso_mvehi"]."</td>";
                                    $html .= "<td>".$val_detalle["fecha_salida_mvehi"]."</td>";
                                    $html .= "<td>".$val_detalle["comentario_mvehi"]."</td>";
                                    $html .= "<td>".$val_detalle["valor_mvehi"]."</td>";
                                    $html .= "</tr>";
                                }
                                    $html .= "<tr>";
                                    $html .= "<td>"."</td>";
                                    ...
                                    $html .= "<td>"."</td>";
                                    $html .= "<td>"."</td>";
                                    $html .= "<td>".bcdiv($valor_total,'1', 2)."</td>";
                                    $html .= "</tr>";
                                    $valor_global+=bcdiv($valor_total,'1', 2);
                                    ...
                                    $html .= "<td>"."</td>";
                                    $html .= "<td>"."</td>";
                                    $html .= "<td>".bcdiv($valor_global,'1', 2)."</td>";
                                    $html .= "</tr>";
