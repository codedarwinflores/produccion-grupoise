...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <a href="transancionkardexarmas" class="btn btn-danger"> Volver</a>
      ...
      <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
         ...
         <?php
            function kardex($equipo)
            {
                  ...
                  where historial_kardex.transancion_kardexh=tbl_transacciones_equipo.id and historial_kardex.equipo_kardexh=tbl_armas.codigo and historial_kardex.ubicacion_kardexh= tbl_clientes_ubicaciones.id and historial_kardex.correlativo_kardexh='$equipo'";
                  $sql = Conexion::conectar()->prepare($query01);
                  $sql->execute();
                  return $sql->fetchAll();
            }
