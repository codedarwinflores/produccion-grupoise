  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php
        ...
        function celular($operador) {
            $query = "SELECT * FROM celular $operador";
        ...
        if($operador!="*"){
            $operador="WHERE operador_celular='".$operador."'";
        }
        else{
            $operador="";
        }
      ...
      <div class="table-responsive">
                <table  class="table table-bordered table-striped dt-responsive tablas" width="100%" id="tabladatos">
                    <thead>
                        <tr>
                            <th colspan="10">ISE, S.A. DE C.V.</th>
                        </tr>
                        <tr>
                            <th colspan="10">REPORTE DE INVENTARIO EQUIPO </th>
                        </tr>
                        <tr>
                            <th colspan="10">CELULAR</th>
                        </tr>
                        <tr>
                            <th colspan="10"></th>
                        </tr>
                    ...
                    <tbody> 
                        <?php
                            ...
                            $data_maestra=celular($operador);
                            $correlativo=1;
                            foreach ($data_maestra as $val_maestra) { 


                                $equipo=$val_maestra["codigo"];                       
                            ...
                            $html.="<td>".$val_maestra["descripcion"]."</td>";
                            $html.="<td>".$val_maestra["serie_celular"]."</td>";
                            $html.="<td>".$nombre_ubi."</td>";
                            $html.="<td>".$val_maestra["costo"]."</td>";
                            $html.="<td>0.00"."</td>";
                            $html.="<td>".$val_maestra["imei_celular"]."</td>";
                            $html.="<td>".$val_maestra["sim"]."</td>";
                            $html.="<td>".$val_maestra["operador_celular"]."</td>";
                            $html.="</tr>";               
