  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_facturar($idubicacion) {
        ...
        function fun_equipo($tipo_equipo,$fechahasta_formateada) {
            $query = "SELECT * FROM `historialmovimientosequipos` where tipoequipo_his='$tipo_equipo' and STR_TO_DATE(fecha_movimiento_his, '%d-%m-%Y')<='$fechahasta_formateada' group by id_ubicacion_movimiento_his order by id desc";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
                         ...
                         /* 
                            */
                            ...
                            foreach ($data_maestra as $value) {
                              ...
                              $data_factura=fun_facturar($idubicacion);
                              $facturar=0;
                              foreach ($data_factura as $val_fac) {
                                $facturar=$val_fac["total"];
                              }
                              ...
                              foreach ($data_ubi as $subvalue) {
                               ...
                               $auto_arma=$subvalue["cantidad_armas"];
                               $auto_radio=$subvalue["cantidad_radios"];
                               $auto_celular=$subvalue["cantidad_celulares"];
                            ...
                            $arma_auto_global=0;
                            $radio_auto_global=0;
                            $celular_auto_global=0;

                            $arma_asig_global=0;
                            $radio_asig_global=0;
                            $celular_asig_global=0;

                            $arma_dif_global=0;
                            $radio_dif_global=0;
                            $celular_dif_global=0;
                            ...
                            foreach ($agrupado as $jefe => $jefeData) {
                                ...
                                foreach ($jefeData as $nombre_coor => $coorData) {
                                    ...
                                    $html .= "<td>COMODIN"."</td>";
                                    /* arma */
                                    $html .= "<td>AUTORIZADAS"."</td>";
                                    $html .= "<td>ASIGNADAS"."</td>";
                                    $html .= "<td>DIF"."</td>";
                                    ...
                                    $arma_auto_total=0;
                                    $radio_auto_total=0;
                                    $celular_auto_total=0;

                                    $arma_asig_total=0;
                                    $radio_asig_total=0;
                                    $celular_asig_total=0;
                                    ...
                                    foreach ($coorData['detalle'] as $ubicacion) {
                                        ...
                                        $data_equipo=fun_equipo('arma',$fechahasta_formateada);
                                        $arma_asig=0;
                                        foreach ($data_equipo as $val_equipo) {
                                            if($val_equipo["id_ubicacion_movimiento_his"]==$ubicacion["idubicacion"]){
                                             $arma_asig=$val_equipo["armas_asig_movimiento_his"];
                                            }
                                        }
                                        $data_equipo=fun_equipo('radio',$fechahasta_formateada);
                                        $radio_asig=0;
                                        foreach ($data_equipo as $val_equipo) {
                                            if($val_equipo["id_ubicacion_movimiento_his"]==$ubicacion["idubicacion"]){
                                                $radio_asig=$val_equipo["radios_asign_movimiento_his"];
                                            }
                                        }
                                        $data_equipo=fun_equipo('celular',$fechahasta_formateada);
                                        $celular_asig=0;
                                        foreach ($data_equipo as $val_equipo) {
                                            if($val_equipo["id_ubicacion_movimiento_his"]==$ubicacion["idubicacion"]){
                                                 $celular_asig++;
                                        ...
                                        $diferencia_arma=$ubicacion["auto_arma"]-$arma_asig;
                                        $diferencia_radio=$ubicacion["auto_radio"]-$radio_asig;
                                        $diferencia_celular=$ubicacion["auto_celular"]-$celular_asig;

                                        $html .= "<td>".$ubicacion["auto_arma"]."</td>";
                                        $html .= "<td>".$arma_asig."</td>";
                                        $html .= "<td>".$diferencia_arma."</td>";

                                        
                                        $html .= "<td>".$ubicacion["auto_radio"]."</td>";
                                        $html .= "<td>".$radio_asig."</td>";
                                        $html .= "<td>".$diferencia_radio."</td>";

                                        
                                        $html .= "<td>".$ubicacion["auto_celular"]."</td>";
                                        $html .= "<td>".$celular_asig."</td>";
                                        $html .= "<td>".$diferencia_celular."</td>";

                                        $html .= "<td>".$ubicacion["facturar"]."</td>";

                                        $html .= "</tr>";

                                        $arma_auto_total+=$ubicacion["auto_arma"];
                                        $radio_auto_total+=$ubicacion["auto_radio"];
                                        $celular_auto_total+=$ubicacion["auto_celular"];

                                        $arma_asig_total+=$arma_asig;
                                        $radio_asig_total+=$radio_asig;
                                        $celular_asig_total+=$celular_asig;

                                        $arma_dif_total+=$diferencia_arma;
                                        $radio_dif_total+=$diferencia_radio;
                                        $celular_dif_total+=$diferencia_celular;

                                        $facturar_total+=$ubicacion["facturar"];
                                    }
                                    $cuenta=1;
                                    ...
                                    $arma_auto_global+=$arma_auto_total;
                                    $arma_asig_global+=$arma_asig_total;
                                    $arma_dif_global+=$arma_auto_total;

                                    $radio_auto_global+=$radio_auto_total;
                                    $radio_asig_global+=$radio_asig_total;
                                    $radio_dif_global+=$radio_auto_total;

                                    $celular_auto_global+=$celular_auto_total;
                                    $celular_asig_global+=$celular_asig_total;
                                    $celular_dif_global+=$celular_auto_total;

                                    $facturar_total_global+=$facturar_total;
                                    ...
                                    /* arma */
                                    $html .= "<td>".$arma_auto_total."</td>";
                                    $html .= "<td>".$arma_asig_total."</td>";
                                    $html .= "<td>".$arma_dif_total."</td>";

                                    /* radio */
                                    $html .= "<td>".$radio_auto_total."</td>";
                                    $html .= "<td>".$radio_asig_total."</td>";
                                    $html .= "<td>".$radio_dif_total."</td>";

                                    
                                    /* celular */
                                    $html .= "<td>".$celular_auto_total."</td>";
                                    $html .= "<td>".$celular_asig_total."</td>";
                                    $html .= "<td>".$celular_dif_total."</td>";

                                    $html .= "<td>".$facturar_total."</td>";
                            ...
                            $diferencia_global=$personal_asignado_global-$empleado_contra;
                                    ...
                                    $html .= "<td>"."</td>";
                                    $html .= "<td>"."</td>";
                                    $html .= "<td>".$arma_auto_global."</td>";
                                    $html .= "<td>".$arma_asig_global."</td>";
                                    $html .= "<td>".$arma_dif_global."</td>";

                                    $html .= "<td>".$radio_auto_global."</td>";
                                    $html .= "<td>".$radio_asig_global."</td>";
                                    $html .= "<td>".$radio_dif_global."</td>";

                                    $html .= "<td>".$celular_auto_global."</td>";
                                    $html .= "<td>".$celular_asig_global."</td>";
                                    $html .= "<td>".$celular_dif_global."</td>";
