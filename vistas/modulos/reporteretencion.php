                ...
                <table  class="table table-bordered table-striped dt-responsive tablas" width="100%" id="tabladatos">
                    ...
                    <tbody> 
                        <?php
                            ...
                            /* ------------------- */                            
                            $data_meses=planillaadminmessinempleado();
                            foreach ($data_meses as $value) {
                                # code...
                                /* $mes = date("F", mktime(0, 0, 0, $value['mes'], 1)); */
                                $mes = $meses[$value['mes']];
                                $html.="<td>-----"."</td>";
                                $html.="<td>".$mes."</td>";
                                $html.="<td>-----"."</td>";
                            ...
                            foreach ($array_depa_maestra as $val_maestra) {
                                ...
                                foreach ($array_planilla_admin as $val_empleado) {
                                        if ($val_empleado["id_departamento_empresa"] == $id_depa) {
                                            ...
                                            /* ------------------- */                            
                                            $data_meses=planillaadminmes($idempleado_admin);
                                            foreach ($data_meses as $datos_plames) {
                                                ...
                                                $mes=floatval($datos_plames["mes"]);


                                                $data_devengos_mes=devengos_contodo($idempleado_admin,$mes);
