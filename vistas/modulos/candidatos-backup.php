        ...
        <div class="col-md-12" align="left">              
            ...
            <div class="col-md-12" > 
                ...
                <div class="col-md-4" > 
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                            <input type="text" class="form-control input-lg apellido_casada" name="nuevoApellidoCasada" placeholder="Ingresar Apellido Casada" >
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12" > 
                <div class="col-md-4" > 
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="input-group">              
                            <span class="input-group-addon"><i class="fa fa-map"></i></span> 
                            <select class="form-control input-lg mi-selector" name="nuevoDepartamento" id="nuevoDepartamento" onchange='poblarMuni()'>                  
                ...
                <div class="col-md-4" > 
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="input-group">              
                            <span class="input-group-addon"><i class="fa fa-map"></i></span> 
                            <select class="form-control input-lg mi-selector" name="nuevoMunicipio" id="nuevoMunicipio" >                  
            ...
            <div class="col-md-12" >                
                ...
                <div class="col-md-4" > 
                    ...
                    <div class="form-group">    
                        ...
                        <div class="input-group">              
                            <span class="input-group-addon"><i class="fa fa-map"></i></span> 
                            <input type="text" class="form-control input-lg" name="nuevoNacionalidad" placeholder="Ingresar Nacionalidad" value="Salvadoreña" >
                        </div>
                    </div>
                </div>
                <div class="col-md-4" > 
            ...
            <div class="col-md-12" > 
                <div class="col-md-6" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">           
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            <input type="text" value="" class="calendario nuevofecha_nacimiento form-control input-lg capturarfechanac" data-lang="es" data-years="1940-2035" data-format="DD-MM-YYYY"  name="" fecha="nuevofecha_nacimiento" placeholder="Ingresar Fecha" readonly>
            ...
            <div class="col-md-12" > 
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="input-group">              
                            ...
                            <select class="form-control input-lg" name="nuevoLicenciaTDA">                  
                                <option value="">Tiene Licencia de portación de arma (LPA)</option>
                ...
                <div class="col-md-6" > 
                    ...
                    <div class="form-group">
                        N&uacute;mero Licencia de portación de arma (LPA):              
                        <div class="input-group">              
                            <span class="input-group-addon"><i class="fa fa-address-card"></i></span> 
                        <input type="text" class="form-control input-lg" name="nuevoNumeroLicenciaTDA" placeholder="Ingresar N&uacute;mero Licencia de portación de arma (LPA)" >
                        </div>
                    </div>
                </div>               
            </div>
            ...
            <div class="col-md-12" >                
                <div class="col-md-12" >
                      ...
                      <div class="form-group">              
                          ...
                          <input type="file" class="imagenlpa" name="nuevaimagenlpa">
                          <p class="help-block">Peso máximo de la foto 2MB</p>
            ...
            <div class="col-md-12" > 
                <div class="col-md-12" >
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="input-group">              
                            <span class="input-group-addon"><i class="fa fa-address-card"></i></span> 
                            <input type="text" class="form-control input-lg" name="nuevoluaf" placeholder="Ingresar Licencia para uso de arma de fuego(LUAF)" >
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12" >
                ...
                <div class="col-md-8 ocultartodo" >
            ...
            <div class="col-md-12" >                
                <div class="col-md-4 noservicio" > 
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">           
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            <input type="text" value="" class="fechainicioservicio calendario nuevofecha_inism form-control input-lg" data-lang="es" data-years="1940-2035" data-format="DD-MM-YYYY"  name="" fecha="nuevofecha_inism" placeholder="Ingresar Fecha" readonly>
                ...
                <div class="col-md-4 noservicio" > 
                    ...
                    <div class="form-group ">
                        ...
                        <div class="input-group">           
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            <input type="text" value="" class="fechafinservicio calendario nuevofecha_finsm form-control input-lg" data-lang="es" data-years="1940-2035" data-format="DD-MM-YYYY"  name="" fecha="nuevofecha_finsm" placeholder="Ingresar Fecha" readonly>
                ...
                <div class="col-md-4 noservicio" > 
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="input-group">              
                            <span class="input-group-addon"><i class="fa fa-map"></i></span> 
                            <input type="text" class="lugarservicioform-control input-lg" name="nuevoLugarServicioMilitar" placeholder="Ingresar Lugar Servicio Militar" >
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12" > 
                <div class="col-md-6" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">              
                            <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                            <select class="form-control input-lg suspendido" name="nuevoSuspendidoAnterior" id="nuevoSuspendidoAnterior" onchange="deshabilitarOpcionesSuspension()">                  
                ...
                <div class="col-md-6" > 
                    ...
                    <div class="form-group">   
                        ...
                        <div class="input-group">              
                            <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                            <input type="text" class="form-control input-lg empresasuspencion" name="nuevoEmpresaSuspendio" id="nuevoEmpresaSuspendio" placeholder="Ingresar Empresa que Suspendi&oacute;" >
                        </div>
                    </div>
                </div>               
            </div>
            ...
            <div class="col-md-12" > 
                <div class="col-md-6" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">           
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            <input type="text" value="" class="calendario nuevofecha_susp form-control input-lg fechasuspencion" data-lang="es" data-years="1940-2035" data-format="DD-MM-YYYY"  name="" id="fechasuspnew" fecha="nuevofecha_susp" placeholder="Ingresar Fecha" readonly>
                ...
                <div class="col-md-6" > 
                    ...
                    <div class="form-group">     
                        ...
                        <div class="input-group">              
                            <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                            <input type="text" class="form-control input-lg motivosuspension" name="nuevoMotivoSuspension" id="nuevoMotivoSuspension" placeholder="Ingresar Motivo de Suspensi&oacute;n" >
                        </div>
                    </div>
                </div>               
            </div>
                ...
                <div class="col-md-6" style="display: none;">
                    ...
                    <div class="form-group">              
                        <div class="panel">SUBIR FOTO DE LA SOLICITUD</div>
                            <input type="text" class="nuevaFotoSOLICITUD" name="nuevaFotoSOLICITUD">
                       <!--      <p class="help-block">Peso máximo de la foto 2MB</p>
            ...
            <div class="col-md-12" >
                ...
                <div class="col-md-4" > 
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">           
                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                            <input type="text" value="" class="form-control input-lg" name="nuevocontacto_empleado" id="" placeholder="Ingresar Medio de contacto"  onKeyPress="if(this.value.length==40) return false;">
                        </div>
                    </div>
                </div>
                <div class="col-md-4" > 
