...
$Nombre_del_Modulo="Planilla Vacación";
...
parse_str($components['query'], $results);
  $id= $results['id'];
  echo "<input type='hidden' class='idplanilladevengo_vacacion' value='".$id."'>";
  ...
  /* ********************* */
    ...
    function validarempleado01($e)
		{
					$query01 = "SELECT * FROM planilladevengo_vacacion WHERE numero_planilladevengo_vacacion='$e' ";
					$sql = Conexion::conectar()->prepare($query01);
					$sql->execute();
					return $sql->fetchAll();
		}
    ...
    ?>
    <input type="hidden" class="tipo_planilladevengo_vacacion1" value="<?php echo $value["tipo_planilladevengo_vacacion"]?>">
    <input type="hidden" class="periodo_planilladevengo_vacacion1" value="<?php echo $value["periodo_planilladevengo_vacacion"]?>">
    <input type="hidden" class="fecha_desde_planilladevengo_vacacion1" value="<?php echo $value["fecha_desde_planilladevengo_vacacion"]?>">
    <input type="hidden" class="fecha_hasta_planilladevengo_vacacion1" value="<?php echo $value["fecha_hasta_planilladevengo_vacacion"]?>">
    <input type="hidden" class="numero_planilladevengo_vacacion1" value="<?php echo $value["numero_planilladevengo_vacacion"]?>">
    <input type="hidden" class="fecha_planilladevengo_vacacion1" value="<?php echo $value["fecha_planilladevengo_vacacion"]?>">
    <input type="hidden" class="descripcion_planilladevengo_vacacion1" value="<?php echo $value["descripcion_planilladevengo_vacacion"]?>">
...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="col-md-12">
          <a href="planillavacacion" class="btn btn-danger">Volver</a>
        </div>
        <div class="col-md-9">
            ...
            <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control " name="tipo_planilladevengo_vacacion" id="tipo_planilladevengo_vacacion" placeholder="Tipo Planilla" value="Vacación">
                </div>
            </div>
          ...
          <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select  class=" form-control " name="periodo_planilladevengo_vacacion" id="periodo_planilladevengo_vacacion" placeholder="Periodo">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="calendario form-control " name="fecha_desde_planilladevengo_vacacion" id="fecha_desde_planilladevengo_vacacion"   data-lang="es" data-years="2010-2060" data-format="DD-MM-YYYY" readonly placeholder="Fecha Desde">
              </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                  <label for="exampleInputEmail1">Fecha Hasta:</label>
                  <input type="text" class="calendario form-control " name="fecha_hasta_planilladevengo_vacacion" id="fecha_hasta_planilladevengo_vacacion"   data-lang="es" data-years="2010-2060" data-format="DD-MM-YYYY" readonly placeholder="Fecha Hasta">
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" class=" form-control " name="numero_planilladevengo_vacacion" id="numero_planilladevengo_vacacion"   placeholder="Número">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                  <label for="exampleInputEmail1">Fecha:</label>
                  <input type="text" class="calendario form-control " name="fecha_planilladevengo_vacacion" id="fecha_planilladevengo_vacacion"   readonly placeholder="Fecha">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class=" form-control " name="descripcion_planilladevengo_vacacion" id="descripcion_planilladevengo_vacacion" placeholder="Fecha" value="Planilla de Vacación desde">
                </div>
            </div>
  ...
  <!-- *************************** -->
          ...
          <!-- ***************** -->
            ...
            <div class="row box-body">
              <div class="col-md-4 box-body">
                <button class="btn btn-primary mostrar_devengo_vacacion" tipo="Suma" data-toggle="modal" data-target="#myModal" disabled="disabled">Agregar Devengo</button>
              </div>

              <div class="col-md-4 box-body">
                <button class="btn btn-success mostrar_devengo_vacacion" tipo="Resta" data-toggle="modal" data-target="#descuento" disabled="disabled">Agregar Descuento</button>
              </div>
        ...
        <div class="col-md-8" id="formulario_original">
          ...
          <!-- ***************** -->
            ...
            <input type="hidden" name="codigo_empleado_planilladevengo_vacacion" id="codigo_empleado_planilladevengo_vacacion">
            <input type="hidden" name="nombre_empleado_planilladevengo_vacacion" id="nombre_empleado_planilladevengo_vacacion">
            <input type="hidden" name="id_empleado_planilladevengo_vacacion" id="id_empleado_planilladevengo_vacacion">
            <div class="col-md-12">
            <div class="form-group"> <label>Empleado Seleccionado: <span id="nombreempleado"></span></label></div>
              ...
              <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="dias_trabajo_planilladevengo_vacacion" id="dias_trabajo_planilladevengo_vacacion" placeholder="Dias Trabajado" value="15" readonly>
                  </div>
              </div>
              <div class="col-md-2">
                  <div class="form-group">
              ...
              <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="sueldo_planilladevengo_vacacion" id="sueldo_planilladevengo_vacacion" placeholder="Sueldo" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="hora_extra_diurna_planilladevengo_vacacion" id="hora_extra_diurna_planilladevengo_vacacion" placeholder="Hora Extra Diurna" calculo="calculo_extra_diurna">
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="hora_extra_nocturna_planilladevengo_vacacion" id="hora_extra_nocturna_planilladevengo_vacacion" placeholder="Hora Extra Nocturna" calculo="calculo_extra_nocturna">
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="hora_extra_domingo_planilladevengo_vacacion" id="hora_extra_domingo_planilladevengo_vacacion" placeholder="Hora Extra Domingo" calculo="calculo_extra_domingo">
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="hora_extra_domingo_nocturna_planilladevengo_vacacion" id="hora_extra_domingo_nocturna_planilladevengo_vacacion" placeholder="Hora Extra Domingo Nocturna" calculo="calculo_extra_domingo_noctu">
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="otro_devengo_vacacion_planilladevengo_vacacion" id="otro_devengo_vacacion_planilladevengo_vacacion" placeholder="Otro devengo_vacacion">
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="total_devengo_vacacion_planilladevengo_vacacion" id="total_devengo_vacacion_planilladevengo_vacacion" placeholder="Total Devengado" style="border:1px solid green;" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="descuento_isss_planilladevengo_vacacion" id="descuento_isss_planilladevengo_vacacion" placeholder="Descuento ISSS" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="descuento_afp_planilladevengo_vacacion" id="descuento_afp_planilladevengo_vacacion" placeholder="Descuento AFP" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="descuento_renta_planilladevengo_vacacion" id="descuento_renta_planilladevengo_vacacion" placeholder="Descuento Renta" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="otro_descuento_planilladevengo_vacacion" id="otro_descuento_planilladevengo_vacacion" placeholder="Otro Descuento" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="total_descuento_planilladevengo_vacacion" id="total_descuento_planilladevengo_vacacion" placeholder="Total Descuento" style="border:1px solid red;" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="total_liquidado_planilladevengo_vacacion" id="total_liquidado_planilladevengo_vacacion" placeholder="Total Liquidado" value="0" style="border:1px solid blue;" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="sueldo_renta_planilladevengo_vacacion" id="sueldo_renta_planilladevengo_vacacion" placeholder="Sueldo Renta" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="sueldo_isss_planilladevengo_vacacion" id="sueldo_isss_planilladevengo_vacacion" placeholder="Sueldo ISSS" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="sueldo_afp_planilladevengo_vacacion" id="sueldo_afp_planilladevengo_vacacion" placeholder="Sueldo AFP" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control mi-selector"  name="departamento_planilladevengo_vacacion" id="departamento_planilladevengo_vacacion">
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="hidden" name="codigo_ubicacion_planilladevengo_vacacion" id="codigo_ubicacion_planilladevengo_vacacion">

                    <input type="text" class="form-control " name="nombre_ubicacion_planilladevengo_vacacion" id="nombre_ubicacion_planilladevengo_vacacion" placeholder="Ubicación" readonly>

                    <input type="hidden" name="id_ubicacion_planilladevengo_vacacion" id="id_ubicacion_planilladevengo_vacacion">
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="observacion_planilladevengo_vacacion" id="observacion_planilladevengo_vacacion" placeholder="Observación">
                  </div>
              </div>
...
<input type="hidden"  id="devengodevengo_vacacion">
...
<input type="hidden"  id="porcentaje_base1f" value="0">
<input type="hidden"  id="porcentaje_base2f" value="0">
<input type="hidden"  id="tasa_sobre_excedentef" value="0">
                  ...
                  <?php
                      ...
                      foreach ($data01 as $value){
                        ...
                        <tr>
                          ...
                          <td>
                            <button class="btn btn-success select_empleado" id="<?php echo $value["id"]?>" codigo="<?php echo $value["codigo_empleado"]?>" sueldo="<?php echo $value["sueldo"]?>" codigo="<?php echo $value["codigo_empleado"]?>"  nombre="<?php echo $value["primer_nombre"].' '.$value["segundo_nombre"].' '.$value["tercer_nombre"].' '.$value["primer_apellido"].' '.$value["segundo_apellido"].' '.$value["apellido_casada"]?>">Agregar</button>
                          </td>
                        </tr>
