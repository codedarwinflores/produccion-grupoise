    ...
    <div class="box">
      ...
      <div class="table-responsive">
                <table  class="table table-bordered table-striped dt-responsive tablas" width="100%" id="tabladatos">
                    <thead>
                        <tr>
                            <th colspan="11">INVESTIGACIONES Y SEGURIDAD S.A. DE C.V. </th>
                        </tr>
                        <tr>
                            <th colspan="11"></th>
                        </tr>
                        <tr>
                            <th colspan="11"><?php echo $fechaActual?></th>
                        </tr>
                        <tr>
                            <th colspan="11"></th>
                        </tr>
                    ...
                    <tbody> 
                        <?php
                            ...
                            $html.="<td>CARGO"."</td>";
                            $html.="<td>UNIDAD"."</td>";
                            $html.="<td>UBICACION CENTRO DE TRABAJO"."</td>";
                            $html.="<td>FECHA DE INGRESO"."</td>";
                            $html.="<td>DIRECCION"."</td>";
                            $html.="<td>DEPTO/MUNIC"."</td>";
                            $html.="<td>TELEFONO"."</td>";
                            $html.="</tr>";
                        
                            $data_maestra=empleado();
                            if($cargo_maestro!="*"){
                                $data_maestra=empleado_cargo($cargo_maestro);
                            }
                            else{
                                $data_maestra=empleado();
                            }
                            ...
                            foreach ($data_maestra as $val_maestra) { 
                                ...
                                $html.="<td>".$nombre_cargo." ".$apellidos."</td>";
                                $html.="<td>".trim($namecargo)."</td>";
                                $html.="<td>".trim($nombrecliente)."</td>";
                                $html.="<td>"."</td>";
                                $html.="<td>".trim($fecha_con)."</td>";
                                $html.="<td>".trim($nombreubicacion)."</td>";
                                $html.="<td>".trim($depa_muni)."</td>";
                                $html.="<td>".trim($telefono_contacto)."</td>";                            
                                $html.="</tr>";
