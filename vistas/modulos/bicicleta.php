      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        ?>
          ...
          ?>
             ...
             <div class="s_estado_bicicleta">
              <label for="">Seleccione Estado</label>
                <div class="input-group ">
                    <span class="input-group-addon"><i class="fa fa-users"></i></span>
                    <select name="nuevoestado_bicicleta" id="nuevoestado_bicicleta" class="form-control input-lg" required>
             ...
             <div class="input-group ">
                ...
                <select name="nuevoid_familia" id="" class="form-control input-lg" required>
                  ...
                  <?php
                            function familia() {
                              $query = "SELECT `id`, `codigo`, `nombre`, `correrlativo` FROM `tbl_familia` WHERE nombre LIKE 'bici%';";
                              $sql = Conexion::conectar()->prepare($query);
                              $sql->execute();			
                              return $sql->fetchAll();
                            };
 ...
 -->
         ...
         <label for="" class="label_<?php echo $row['Field'];?>"></label> 
          ...
          ?>
            ...
            <div class="editar_s_estado_bicicleta">
              <label for="">Seleccione Estado</label>
                <div class="input-group ">
                    <span class="input-group-addon"><i class="fa fa-users"></i></span>
                    <select name="editarestado_bicicleta" id="editarestado_bicicleta" class="form-control input-lg" required>
                      <option value="">Seleccione Estado</option>
                      <option value="Activo">Activo</option>
                      <option value="Inactivo">Inactivo</option>
                    </select>
