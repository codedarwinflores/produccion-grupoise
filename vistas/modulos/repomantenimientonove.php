    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_mantenimiento_grupo($fecha_desde, $fecha_hasta, $condicion) {
            ...
            WHERE fecha BETWEEN '$fecha_desde' AND '$fecha_hasta' $condicion ";/* 2023-12-31 formato fecha */  
      ...
      <input type="hidden" class="titulo_reportes" value="REPORTE CONTROL NOVEDADES DE FLOTA ">
      ...
      <div class="table-responsive">
                <table  class="table table-bordered table-striped dt-responsive" width="100%" id="tabladatos">
                    <thead>
                        ...
                        <tr>
                            <th class="colspan">CONTROL NOVEDADES DE FLOTA </th>
                        </tr>
                        <tr>
                        ...
                        <?php
                            ...
                            foreach ($data_mante as $val_mante) {
                                ...
                                if($cuenta_repara>0){
                                    ...
                                    $html .= "<td>".$val_mante["diagnostico_mvehi"]."</td>";
                                    $html .= "</tr>";
                                }
                            }
