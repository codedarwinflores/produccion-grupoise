 ...
 ?>
  ...
  <section class="content">
    ...
    /*     $fecha_desde = strtotime($fechadesde);
      ...
      <input type="hidden" class="titulo_reportes" value="REPORTE UBICACIONES BOTON INSPECCION">
                            ...
                            foreach ($agrupado as $jefe => $jefeData) {
                                ...
                                foreach ($jefeData as $nombre_coor => $coorData) {
                                    ...
                                    foreach ($coorData['detalle'] as $ubicacion) {
                                        ...
                                        $html .= "<tr>";
                                        $html .= "<td>"."</td>";
                                        $html .= "<td>POSICION: ".$ubicacion["codigo_ubicacion"]." ".$ubicacion["nombre_ubicacion"]."</td>";
                                        $html .= "<td>"."</td>";
                                        $html .= "<td>"."</td>";
                                        $html .= "<td>"."</td>";
                                        ...
                                        foreach ($data_asigna as $val_asig) {
                                            ...
                                            if($partes[0]==$ubicacion["codigo_ubicacion"]){
                                                ...
                                                $html .= "<tr>";
                                                $html .= "<td>".$cuenta_agen++."</td>";
                                                $html .= "<td>".$val_asig["codigo_empleado"]."</td>";
                                                $html .= "<td>".$nombre_cargo."</td>";
                                                $html .= "<td>".$val_asig["direccion"]."</td>";
                                                $html .= "<td>"."</td>";
                                                $html .= "<td>"."</td>";/*  */
                                                $html .= "<td>"."</td>";/*  */
                                                $html .= "<td>"."</td>";/*  */
