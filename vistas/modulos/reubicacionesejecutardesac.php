    ...
    <div class="box">
      ...
      <?php
        ...
        function ubicaciones() {
            $query = "SELECT tbl_clientes_ubicaciones.*,clientes.* 
                      FROM tbl_clientes_ubicaciones,clientes
                      WHERE  tbl_clientes_ubicaciones.id_cliente=clientes.id and
                      tbl_clientes_ubicaciones.fecha_fin is not null  AND fecha_fin > '0000-00-00 00:00:00'";
                ...
                <table  class="table table-bordered table-striped dt-responsive" width="100%" id="tabladatos">
                    ...
                    <tbody> 
                        <?php
                            ...
                            $array_datos=[];
                            $data_maestra=ubicaciones();
                            foreach ($data_maestra as $value) {

                                $id_depa=$value["id_departamento"];
                                $data_depa=departamento($id_depa);
                                $nombre_depa="";
                                ...
                                $array_datos[]=array(
                                    "rubro"=>$value["rubro"],
                                    "nombre"=>$value["nombre_ubicacion"],
                                    "direccion"=>$value["direccion"],
                                    "fecha_fin"=>$value["fecha_fin"],
                                    "departamento"=>$nombre_depa
                                );
                            }
                            $rubros_mostradas = array();
                            $cuenta=1;
                            foreach ($array_datos as $value) {
                                $rubro = $value["rubro"];
                                if (!in_array($rubro, $rubros_mostradas)) {
                                    $html.= "<tr>";
                                    $html.= "<td class='colspan'>RUBRO: $rubro</td>";
                                    $html.= "</tr>";
                                    $rubros_mostradas[] = $rubro;
                                ...
                                $html.="<tr>";
                                $html.="<td>".str_pad($cuenta++, 6, '0', STR_PAD_LEFT)."</td>";
...
<script>
    ...
    $("#exportTXT").click(function () {
            ...
            guardarComoArchivoTexto(contenidoTexto, 'REPORTE UBICACIONES BOTON EJECUTAR.txt');
    ...
    $("#exportPDF").click(function () {
       ...
       fontSize: 5,
        ...
        doc.save('REPORTE UBICACIONES BOTON EJECUTAR.pdf');
                /* ************* */
    })
    ...
    $("#exportExcel").click(function () {
       ...
       /*  ws['!cols'][0] = { wch: 10, };
        ...
        XLSX.writeFile(wb, "REPORTE UBICACIONES BOTON EJECUTAR.xlsx");
