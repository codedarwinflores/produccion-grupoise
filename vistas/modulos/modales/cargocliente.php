          ...
          <div class="modal-content">
              <form action="#" method="POST" id="form_cargo_cliente">
                  ...
                  <div class="modal-header bg-blue-gradient" style=" color: #fff;">
                      ...
                      <h4 class="modal-title"><span id="editartitlecargo">Registrar</span> Cargo Cliente</h4>
  ...
  <!-- CARGO MODAL -->
  <div class="modal fade" tabindex="-1" data-backdrop="static" id="modalAgregarCargoEvaluado">
      <div class="modal-dialog">
          <div class="modal-content">
              <form action="#" method="POST" id="form_cargo_evaluado">
                  <input type="hidden" name="save_process_cargoevaluado" value="ok" id="save_process_cargoevaluado">
                  <input type="hidden" name="id_edit_cargoevaluado" value="0" id="id_edit_cargoevaluado">
                  <input type="hidden" name="type_action_form" value="save" id="type_action_form_cargo_evaluado">
                  <div class="modal-header bg-blue-gradient" style=" color: #fff;">
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                      <h4 class="modal-title"><span id="editartitlecargoevaluado">Registrar</span> Cargo Evaluado</h4>

                  </div>
                  <div class="modal-body">

                      <!-- Alerta de Bootstrap para mostrar mensajes -->
                      <div class="alert" role="alert" id="mensajeFormCargoEvaluado" style="display: none;"></div>
                      <fieldset>
                          <legend>
                              <h5>Información requerida: </h5>
                          </legend>
                          <div class="row">
                              <div class="col-xs-12 col-sm-12">
                                  ...
                                  <div class="input-group">
                                      <span class="input-group-addon"><i class="fa fa-comment"></i></span>
                                      <textarea name="nombre_cargo" id="nombre_cargo_evaluado" placeholder="Ingresar Cargo" class="form-control input-lg" required></textarea>
                                  </div>
                              </div>
                          </div>
                      </fieldset>
                  ...
                  <div class="modal-footer">
                      <div class="text-end">
                          ...
                          <button type="submit" class="btn btn-success bg-green-gradient btn-sm" id="btn-idsaveeditcargoevaluado"><i class="fa fa-pencil-square-o"></i> Registrar</button>
                          <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Salir</button>
                      </div>
                  </div>
              </form>
