      ...
      <div class="box-body">
        <div class="row">
                ...
                <div class="col-md-12">
                            ...
                            <!-- ********************** -->
                            <div class="col-md-12 " >
                              <form action="reporteplanillacontable" method="post" target="_blank" >
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <select class="form-control tipo_planilla" name="tipo_planilla">
                                      ...
                                      <!-- SOLO ESTA PORQUE NECESITA LA PLANILLA DE VACACION Y ESE CAMPO NO ESTA EN LAS OTRAS PLANILLAS -->
