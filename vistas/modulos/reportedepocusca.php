                    ...
                    ?>                
                                ...
                                <tr>
                                    <!-- a depositar -->
                                        <td>
                                             <?php 
                                                $total_global+=bcdiv($row_data_planilla_admin["total_liquidado_planilladevengo".$cambio_table.""],'1', 2);
                                                 echo  trim(bcdiv($row_data_planilla_admin["total_liquidado_planilladevengo".$cambio_table.""],'1', 2))." ";
                                             ?>
                                       </td>
                                         <!-- cuenta -->
