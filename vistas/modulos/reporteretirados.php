...
function retiro($fechadesde1,$fechahasta2){
    $query = "SELECT retiro.*, tbl_empleados.*  FROM `retiro`,tbl_empleados where retiro.idempleado_retiro=tbl_empleados.id and estado_retiro='Inactivo' and STR_TO_DATE(fecha_retiro, '%d-%m-%Y')  BETWEEN '$fechadesde1' AND '$fechahasta2'";
...
<div style="height: 50px;"></div>
  <header align="center">
         ...
         <h6 align="center" class="texto_titulo">AGENTES DE SEGURIDAD PRIVADA RETIRADOS POR DIFERENTES CAUSAS DE LAS POSICIONES</h6>
         <br>
   ...
   <table>
    <tr>
        ...
        <!-- **********INICIO DEL REPORTE************ -->
                ...
                <td>
                    <span class="textos"><?php echo $value["numero_documento_identidad"]?></span>
                </td>
                <td>
                    <span class="textos"><?php echo $value["fecha_ingreso"]?></span>
                </td>
                <td>
                    <span class="textos"><?php echo $value["fecha_retiro"]?></span>
                </td>
                <td>
                    <span class="textos"><?php echo $value["causa_retiro"]?></span>
                </td>
                <td>
