    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_tra_equipo_actual($fecha, $condicion) {
            ...
            ) and STR_TO_DATE(fecha_movimiento_his, '%d-%m-%Y') <= STR_TO_DATE('$fecha', '%d-%m-%Y') and tipoequipo_his='radio' $condicion
                        ...
                        <?php
                            ...
                            foreach ($data_movi_his as $va_movi) {
                                ...
                                foreach ($data_arma as $val_arma) {
                                    $nom_radio=$val_arma["descripcion_radio"];
                                    $matri_radio=""/* $val_arma["numero_matricula"] */;
                                    $venci_radio=""/* $val_arma["fecha_vencimiento"] */;
                                    $serie_radio=$val_arma["numero_serie"];
                                }
                                ...
                                $venci_radio = strtotime($venci_radio);
                                $venci_radio = date("d-m-Y", $venci_radio);

                                $html .= "<tr>";
                                $html .= "<td>".$cadena_con_ceros."</td>";
                                $html .= "<td>".$va_movi["fecha_ingreso_movimiento_his"]."</td>";
                                $html .= "<td>".$va_movi["fecha_movimiento_his"]."</td>";
                                $html .= "<td>".$nom_radio."</td>";
                                $html .= "<td>".$matri_radio."</td>";
                                $html .= "<td>".$venci_radio."</td>";
                                $html .= "<td>".$serie_radio."</td>";
