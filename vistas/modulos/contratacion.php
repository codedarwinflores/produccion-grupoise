      ...
      <div class="box-body" id="impresion">       
        ...
        <div class="col-md-12" align="left">              
            <form role="form" method="post" enctype="multipart/form-data">
             ...
             <input type="hidden" name="idEmpleado" id="idEmpleado" value="<?php echo $_POST["idEmpleado"]?>"> 
            ...
            <div class="col-md-12" > 
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">              
                        ...
                        <select class="form-control input-lg estadoempleado" name="editarEstado" required="required">                  
                ...
                <div class="col-md-4" > 
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">              
                      ...
                      <input type="text" class="form-control input-lg" id="editarNombre" name="editarNombre" value="" required="required">
                    </div>
                  </div>
                </div>
                <div class="col-md-4" > 
            ...
            <div class="col-md-12" > 
                <div class="col-md-4" > 
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">              
                          <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                          <input type="text" class="form-control input-lg" id="editarPrimerApellido" name="editarPrimerApellido" value="" required="required">
                        </div>
                      </div>
                </div>
                <div class="col-md-4" > 
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">              
                        <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                        <input type="text" class="form-control input-lg" id="editarSegundoApellido" name="editarSegundoApellido" value="" required="required">
                      </div>
                    </div>
                </div>
            ...
            <div class="col-md-12 ocultarisss" > 
                <div class="col-md-6" > 
                    ...
                    N&uacute;mero de ISSS:             
                      <div class="input-group">              
                        <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                        <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control input-lg numero_isss_valida" id="editarNumeroIsss" name="editarNumeroIsss" value="" placeholder="Ingresar N&uacute;mero de ISSS">
                      </div>
                    </div>
                </div>
                <div class="col-md-6" > 
            ...
            <div class="col-md-12" > 
                <div class="col-md-6" > 
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">              
                        <span class="input-group-addon"><i class="fa fa-users"></i></span> 
                        <select class="form-control input-lg" name="editarTipoDocumento" required="required">                  
                ...
                <div class="col-md-6" > 
                    ...
                    N&uacute;mero Documento Identidad:
                      <div class="input-group">              
                        <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                        <input type="text" class="form-control input-lg input_dui duis"  id="editarNumeroDocumento" name="editarNumeroDocumento" value="" required="required">
                      </div>
                    </div>
                </div>               
            </div>
            ...
            <div class="col-md-12" > 
                <div class="col-md-4" > 
                    ...
                    N&uacute;mero de Licencia de Conducir:             
                      <div class="input-group">              
                        <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                        <input type="text"  class="form-control input-lg input_nit nits" id="editarNumeroLicenciaConducir" name="editarNumeroLicenciaConducir" value="" placeholder="Ingresar N&uacute;mero de Licencia de Conducir">
                      </div>
                    </div>
                </div>
                <div class="col-md-4" > 
                    ...
                    Fecha de vencimiento de Licencia de Conducir:             
                      <div class="input-group">              
                        <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                        <input type="text" class="form-control input-lg calendario " id="editarfecha_venc_licenciaconducir" name="editarfecha_venc_licenciaconducir" value="" placeholder="Ingresar Fecha de vencimiento de Licencia de Conducir">
                      </div>
                    </div>
                </div>
            ...
            <div class="col-md-12" > 
                ...
                <div class="col-md-6" > 
                    ...
                    Centro de Estudio:             
                        <div class="input-group">              
                          <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                          <input type="text"  class="form-control input-lg" id="editarPlantel" name="editarPlantel" value="" placeholder="Ingresar Centro de Estudio">
                        </div>
                    </div>
                </div>               
            </div>
                ...
                <div class="col-md-4" > 
                     <!-- ENTRADA PARA PESO-->            
                      ...
                      Peso (LB):                
                        <div class="input-group">              
                          <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                          <input type="text" class="form-control input-lg onlydecimal" id="editarPeso" name="editarPeso" value="" placeholder="Ingresar Peso">
                        </div>
                      </div>
                </div>
                <div class="col-md-4" > 
                    ...
                    <div class="form-group">  
                      Color de Piel:            
                        <div class="input-group">              
                          ...
                          <select class="form-control input-lg" id="editarPiel" name="editarPiel">
                ...
                <div class="col-md-4" > 
                    ...
                    Color de Ojos:              
                        <div class="input-group">              
                          ...
                          <select class="form-control input-lg" id="editarOjos" name="editarOjos" >
                ...
                <div class="col-md-12" >
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="input-group">              
                            ...
                            <input type="text" class="form-control input-lg luaf" name="editarluaf" placeholder="Ingresar Licencia para uso de arma de fuego(LUAF)" id="editarluaf">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12" >
                <div class="col-md-6" >
                     ...
                     <div class="form-group"> 
                        ...
                        <div class="input-group">                  
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            <input type="text" value="" class="calendario editarfecha_venLTA form-control input-lg" data-lang="es" data-years="1940-2035" data-format="MM-YYYY"  name="" fecha="editarfecha_venLTA" placeholder="Ingresar Fecha" id="mascarafecha_venLTA" readonly>
            ...
            <div class="col-md-12" > 
                ...
                <div class="col-md-6" > 
                    ...
                    Sueldo que Deveng&oacute;:            
                      <div class="input-group">              
                        <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                        <input type="text" class="form-control input-lg onlydinero" id="editarSueldoDevengo" name="editarSueldoDevengo" value="" placeholder="Ingresar Sueldo que Deveng&oacute;">
                      </div>
                    </div>
                </div>               
            </div>
            ...
            <div class="col-md-12" > 
                <div class="col-md-6" >
                    ...
                    <div class="form-group">  
                      Nombre Trabajo Actual:            
                        <div class="input-group">              
                          <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                          <input type="text"  class="form-control input-lg" id="editarTrabajoActual" name="editarTrabajoActual" value="GRUPO ISE" placeholder="Ingresar Trabajo Actual">
                        </div>
                      </div>
                </div>
                ...
                <div class="col-md-6" > 
                    ...
                    Sueldo que Devenga:
                      <div class="input-group">              
                        <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                        <input type="text" class="form-control input-lg onlydinero" id="editarSueldoDevenga" name="editarSueldoDevenga" value="" placeholder="Ingresar Sueldo que Devenga">
                      </div>
                    </div>
                </div>               
            </div>
                ...
                <div class="col-md-4" >
                    ...
                    N&uacute;mero de Personas Dependientes:             
                      <div class="input-group">              
                        ...
                        <select class="form-control input-lg" id="editarPersonasDependientes" name="editarPersonasDependientes">
                ...
                <div class="col-md-12" bis_skin_checked="1">           
                        <div class="form-group" bis_skin_checked="1">   
                            ...
                            <div class="input-group" bis_skin_checked="1">              
                                ...
                                <select class="form-control input-lg editarantecedente_policial validar_antecedente" name="editarantecedente_policial" id="editarantecedente_policial">
            ...
            <div class="col-md-12" >
                ...
                <div class="col-md-4" > 
                    ...
                    CARGO:            
                      <div class="input-group">              
                        <span class="input-group-addon"><i class="fa fa-users"></i></span> 
                        <select class="form-control input-lg editarCARGO mi-selector" name="editarCARGO"  id="editarCARGO0" >
            ...
            <div class="col-md-12" >
                <div class="col-md-4" > 
                    ...
                    Recomendado por:
                      <div class="input-group">           
                          <span class="input-group-addon"><i class="fa fa-user"></i></span>
                          <select class="form-control input-lg mi-selector" name="editarrecomendado_empleado" id="editarrecomendado_empleado" >                  
                ...
                <div class="col-md-4" >
                  ...
                  <div class="form-group">
                    Documentación completa:
                      <div class="input-group">           
                          <span class="input-group-addon"><i class="fa fa-user"></i></span>
                          <select class="form-control input-lg" name="editardocumentacion_empleado" id="editardocumentacion_empleado" required="required">                  
            ...
            <div class="col-md-12" > 
                <div class="col-md-6" style="visibility: hidden; height:0">
                  ...
                  ¿Tiene ANSP?:
                    <div class="input-group">           
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <select class="form-control input-lg" name="editaransp_empleado" id="editaransp_empleado" required="required">                  
                          <option value="No">No</option>
                          <option value="Si">Si</option>
                        </select>
                    </div>
                ...
                <div class="col-md-6" style="visibility: hidden"> 
                    ...
                    Uniforme regalado:
                      <div class="input-group">           
                          <span class="input-group-addon"><i class="fa fa-user"></i></span>
                          <select class="form-control input-lg" name="editaruniformeregalado_empleado" id="editaruniformeregalado_empleado" required="required">                  
                    ...
                    <div class="form-group">  
                       <!-- ENTRADA PARA SUELDO --> 
                        <div class="form-group"> 
                          ...
                          <div class="input-group">           
                              <span class="input-group-addon"><i class="fa fa-user"></i></span>
                              <input type="text"  class="form-control input-lg onlydinero" name="editar_sueldo" id="editar_sueldo" placeholder="Ingresar sueldo" onKeyPress="if(this.value.length==6) return false;">
                          </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4" >
                  <div class="form-group">
                       ...
                       <div class="form-group"> 
                          ...
                          <div class="input-group">           
                              <span class="input-group-addon"><i class="fa fa-user"></i></span>
                              <input type="text" step="any" class="form-control input-lg onlydinero" name="editar_sueldo_diario" id="editar_sueldo_diario" placeholder="Ingresar sueldo diario" onKeyPress="if(this.value.length==7) return false;">
                          </div>
                        </div>
                  </div>
                </div>
                ...
                <div class="col-md-4" > 
                    <div class="form-group">
                        ...
                        <div class="form-group"> 
                          ...
                          <div class="input-group">           
                              <span class="input-group-addon"><i class="fa fa-user"></i></span>
                              <input type="text" class="form-control input-lg " name="editar_hora_extra_domingo" id="editar_hora_extra_domingo" placeholder="Ingresar hora extra domingo"  oninput="validateNumber(this);">
                          </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">  
                       <!-- ENTRADA PARA HX NOCTURNA DOMINGO --> 
                        <div class="form-group"> 
                          ...
                          <div class="input-group">           
                              <span class="input-group-addon"><i class="fa fa-user"></i></span>
                              <input type="text"   class="form-control input-lg " name="editar_hora_extra_nocturna_domingo" id="editar_hora_extra_nocturna_domingo" placeholder="Ingresar hora extra nocturna domingo"  oninput="validateNumber(this);">
                          </div>
                        </div>
                    </div>                      
                </div>                
            ...
            <div class="col-md-12" > 
                ...
                <div class="col-md-4" > 
                    <div class="form-group">
                        ...
                        Descontar ISSS: 
                        <select class="form-control input-lg  descontar_isss" name="editar_descontar_isss"  >                  
                ...
                <div class="col-md-4" >                    
                    <div class="form-group">
                        ...
                        Descontar AFP: 
                        <select class="form-control input-lg descontar_afp" name="editar_descontar_afp"  >                  
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary botonmodificar">Modificar empleado</button>
...
<!--=====================================
MODAL AGREGAR EMPLEADO INACTIVO 
======================================-->

<div id="modalagregarinactivo" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Agregar Empleado Inactivo</h4>
        ...
        <div class="modal-body">
          ...
          <div class="form-group id  gruporetiro_id" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="text" class="form-control input-lg input_id" name="nuevoid" id="nuevoid" placeholder="" value="" autocomplete="off">
              </div>
          </div>
          ...
          <div class="form-group nombre_retiro  gruporetiro_nombre_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="text" class="form-control input-lg input_nombre_retiro" name="nuevonombre_retiro" id="nuevonombre_retiro" placeholder="" value="" autocomplete="off" required="" readonly>
          ...
          <div class="form-group ubicacion_retiro  gruporetiro_ubicacion_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="text" class="form-control input-lg input_ubicacion_retiro" name="nuevoubicacion_retiro" id="nuevoubicacion_retiro" placeholder="" value="" autocomplete="off" required="">
          ...
          <div class="form-group causa_retiro  gruporetiro_causa_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <select name="nuevocausa_retiro" id="nuevocausa_retiro" class="form-control input-lg input_causa_retiro" required="">
          ...
          <div class="form-group fecha_contratacion_retiro  gruporetiro_fecha_contratacion_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="text" class="form-control input-lg input_fecha_contratacion_retiro calendario" name="nuevofecha_contratacion_retiro" id="nuevofecha_contratacion_retiro" placeholder="" value="" autocomplete="off" required="" disabled>
          ...
          <div class="form-group fecha_retiro  gruporetiro_fecha_retiro" bis_skin_checked="1" style="width: 80%;">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="text" class="form-control input-lg input_fecha_retiro calendario" name="nuevofecha_retiro" id="nuevofecha_retiro" placeholder="" value="" autocomplete="off" required="required" readonly>
          ...
          <div class="form-group horas_extras_pentientes_retiro  gruporetiro_horas_extras_pentientes_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="number" class="form-control input-lg input_horas_extras_pentientes_retiro" name="nuevohoras_extras_pentientes_retiro" id="nuevohoras_extras_pentientes_retiro" placeholder="" value="" autocomplete="off" required="">
          ...
          <div class="form-group horas_llegadas_tardes_retiro  gruporetiro_horas_llegadas_tardes_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="number" class="form-control input-lg input_horas_llegadas_tardes_retiro" name="nuevohoras_llegadas_tardes_retiro" id="nuevohoras_llegadas_tardes_retiro" placeholder="" value="" autocomplete="off" required="">
          ...
          <div class="form-group descuento_tarde_retiro  gruporetiro_descuento_tarde_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="number" class="form-control input-lg input_descuento_tarde_retiro" name="nuevodescuento_tarde_retiro" id="nuevodescuento_tarde_retiro" placeholder="" value="" autocomplete="off" required="">
          ...
          <div class="form-group observaciones_retiro  gruporetiro_observaciones_retiro" bis_skin_checked="1">
              ...
              <div class="input-group" bis_skin_checked="1">
                ...
                <input type="text" class="form-control input-lg input_observaciones_retiro" name="nuevoobservaciones_retiro" id="nuevoobservaciones_retiro" placeholder="" value="" autocomplete="off" required="">
              </div>
          </div>
 ...
 -->
                <select  class="form-control input-lg input_estado_retiro" name="nuevoestado_retiro" id="nuevoestado_retiro" required activacion="">
          ...
          <div class="form-group idempleado_retiro  gruporetiro_idempleado_retiro" bis_skin_checked="1" style="visibility:hidden">
              ...
              <div class="input-group" bis_skin_checked="1">      
                ...
                <input type="text" class="form-control input-lg input_idempleado_retiro" name="nuevoidempleado_retiro" id="nuevoidempleado_retiro" placeholder="" value="" autocomplete="off" required="">
              </div>
          </div>
...
echo "<input type='hidden' value=".$modulo." id='nombre_modulo'>";
?>
