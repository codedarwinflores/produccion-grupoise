...
echo isset($_POST['idEmpleado']) ? $_POST['idEmpleado'] : '<script>window.location = "empleados"; </script>';
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control input-lg" id="editarcodigo_empleado" name="editarcodigo_empleado" readonly>
