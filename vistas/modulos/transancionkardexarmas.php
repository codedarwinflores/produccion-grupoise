      ...
      <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
         ...
         <?php
            function kardex()
            {
                  ...
                  $query01="SELECT historial_kardex.id as idkardex,historial_kardex.*,tbl_armas.*,tbl_transacciones_equipo.*,tbl_clientes_ubicaciones.*
                  FROM historial_kardex,tbl_armas,tbl_transacciones_equipo,tbl_clientes_ubicaciones
                  where historial_kardex.transancion_kardexh=tbl_transacciones_equipo.id and historial_kardex.equipo_kardexh=tbl_armas.codigo and historial_kardex.ubicacion_kardexh= tbl_clientes_ubicaciones.id  group by correlativo_kardexh";
           ...
           echo ' <tr>
                   ...
                   echo '<td>
                     ...
                     <div class="btn-group">
                       <a href="detalletransancionkardexarmas?id='.$value["correlativo_kardexh"].'" class="btn btn-warning">Detalle</a>
                ...
                <tr>
                  <td>
                      <select class="form-control mi-selector" name="equipo_kardex" id="equipo_kardex">
                        ...
                        ?>
                          <option value="<?php echo $value["codigo"]?>" costos="<?php echo $value["precio_costo"]?>" descripcion="<?php echo $value["descripcion_arma"]?>"><?php echo $value["codigo"]."-".$value["descripcion_arma"] ?></option>
                        <?php
                        }
                        ?>
                      </select>
