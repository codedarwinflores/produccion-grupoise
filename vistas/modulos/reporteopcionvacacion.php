  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php
        ...
        /* *******CUERPO***** */
        function empleado($mes) {
            $query = "SELECT * FROM `tbl_empleados` where MONTH(fecha_contratacion)='$mes' order by primer_apellido ASC";
      ...
      <div class="table-responsive">
                <table  class="table table-bordered table-striped dt-responsive tablas" width="100%" id="tabladatos">
                    <thead>
                        <tr>
                            <th colspan="5">REPORTE DE VACACIONES</th>
                        </tr>
                        <tr>
                            <th colspan="5"><?php echo $nombreMes?></th>
                        </tr>
                        <tr>
                            <th colspan="5"><?php echo $fechaActual?></th>
                        </tr>
                        <tr>
                            <th colspan="5"></th>
                        </tr>
                    ...
                    <tbody> 
                        <?php
                            ...
                            foreach ($data_maestra as $val_maestra) { 
                                ...
                                $html.="<tr>";
                                $html.="<td>".trim(str_pad($correlativo++, 4, '0', STR_PAD_LEFT))."</td>";
                                $html.="<td>".$apellidos."</td>";
