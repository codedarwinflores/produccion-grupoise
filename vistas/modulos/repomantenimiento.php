    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_mantenimiento_grupo($fecha_desde, $fecha_hasta, $condicion) {
            ...
            WHERE fecha BETWEEN '$fecha_desde' AND '$fecha_hasta' $condicion group by idvehiculo_mante";/* 2023-12-31 formato fecha */  
                    ...
                    <tbody> 
                        <?php
                            ...
                            foreach ($data_mante as $val_mante) {
                                ...
                                $html .= "<tr>";
                                $html .= "<td class='colspan'>PLACA ".$placa_vehi."    ".$codigo_vehi." ".$nombre_vehi."</td>";
                                $html .= "</tr>";
                                    
                                $data_fetalle=fun_mantenimiento($fecha_desde_for, $fecha_hasta_for,$id_vehiculo);
                                $valor_total=0;
