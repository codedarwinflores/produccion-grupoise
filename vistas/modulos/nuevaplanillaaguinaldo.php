...
parse_str($components['query'], $results);
  $id= $results['id'];
  echo "<input type='hidden' class='idplanilladevengo_aguinaldo' value='".$id."'>";
  ...
  /* ********************* */
    ...
    function validarempleado01($e)
		{
					$query01 = "SELECT * FROM planilladevengo_aguinaldo WHERE numero_planilladevengo_aguinaldo='$e' ";
					$sql = Conexion::conectar()->prepare($query01);
					$sql->execute();
					return $sql->fetchAll();
		}
    ...
    ?>
    <input type="hidden" class="tipo_planilladevengo_aguinaldo1" value="<?php echo $value["tipo_planilladevengo_aguinaldo"]?>">
    <input type="hidden" class="periodo_planilladevengo_aguinaldo1" value="<?php echo $value["periodo_planilladevengo_aguinaldo"]?>">
    <input type="hidden" class="fecha_desde_planilladevengo_aguinaldo1" value="<?php echo $value["fecha_desde_planilladevengo_aguinaldo"]?>">
    <input type="hidden" class="fecha_hasta_planilladevengo_aguinaldo1" value="<?php echo $value["fecha_hasta_planilladevengo_aguinaldo"]?>">
    <input type="hidden" class="numero_planilladevengo_aguinaldo1" value="<?php echo $value["numero_planilladevengo_aguinaldo"]?>">
    <input type="hidden" class="fecha_planilladevengo_aguinaldo1" value="<?php echo $value["fecha_planilladevengo_aguinaldo"]?>">
    <input type="hidden" class="descripcion_planilladevengo_aguinaldo1" value="<?php echo $value["descripcion_planilladevengo_aguinaldo"]?>">
...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="col-md-12">
          <a href="planillaaguinaldo" class="btn btn-danger">Volver</a>
        </div>
        <div class="col-md-9">
            ...
            <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control " name="tipo_planilladevengo_aguinaldo" id="tipo_planilladevengo_aguinaldo" placeholder="Tipo Planilla" value="Aguinaldo">
                </div>
            </div>
          ...
          <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select class=" form-control " name="periodo_planilladevengo_aguinaldo" id="periodo_planilladevengo_aguinaldo" placeholder="Periodo">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="calendario form-control " name="fecha_desde_planilladevengo_aguinaldo" id="fecha_desde_planilladevengo_aguinaldo"   data-lang="es" data-years="2010-2060" data-format="DD-MM-YYYY" readonly placeholder="Fecha Desde">
              </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                  <label for="exampleInputEmail1">Fecha Hasta:</label>
                  <input type="text" class="calendario form-control " name="fecha_hasta_planilladevengo_aguinaldo" id="fecha_hasta_planilladevengo_aguinaldo"   data-lang="es" data-years="2010-2060" data-format="DD-MM-YYYY" readonly placeholder="Fecha Hasta">
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" class=" form-control " name="numero_planilladevengo_aguinaldo" id="numero_planilladevengo_aguinaldo"   placeholder="Número" readonly>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                  <label for="exampleInputEmail1">Fecha:</label>
                  <input type="text" class="calendario form-control " name="fecha_planilladevengo_aguinaldo" id="fecha_planilladevengo_aguinaldo"   readonly placeholder="Fecha">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class=" form-control " name="descripcion_planilladevengo_aguinaldo" id="descripcion_planilladevengo_aguinaldo" placeholder="Fecha" value="Planilla de Anticipo desde">
                </div>
            </div>
  ...
  <!-- *************************** -->
          ...
          <!-- ***************** -->
            ...
            <div class="row box-body">
              <div class="col-md-4 box-body">
                <button class="btn btn-primary mostrar_devengo_aguinaldo" tipo="Suma" data-toggle="modal" data-target="#myModal" disabled="disabled">Agregar Devengo</button>
              </div>

              <div class="col-md-4 box-body">
                <button class="btn btn-success mostrar_devengo_aguinaldo" tipo="Resta" data-toggle="modal" data-target="#descuento" disabled="disabled">Agregar Descuento</button>
              </div>
        ...
        <div class="col-md-8" id="formulario_original">
          ...
          <!-- ***************** -->
            ...
            <input type="hidden" name="codigo_empleado_planilladevengo_aguinaldo" id="codigo_empleado_planilladevengo_aguinaldo">
            <input type="hidden" name="nombre_empleado_planilladevengo_aguinaldo" id="nombre_empleado_planilladevengo_aguinaldo">
            <input type="hidden" name="id_empleado_planilladevengo_aguinaldo" id="id_empleado_planilladevengo_aguinaldo">
            <div class="col-md-12">
            <div class="form-group"> <label>Empleado Seleccionado: <span id="nombreempleado"></span></label></div>
              ...
              <div class="col-md-2 ocultar_div">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="dias_trabajo_planilladevengo_aguinaldo" id="dias_trabajo_planilladevengo_aguinaldo" placeholder="Dias Trabajado">
                  </div>
              </div>
              ...
              <div class="col-md-4 ocultar_div">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="sueldo_planilladevengo_aguinaldo" id="sueldo_planilladevengo_aguinaldo" placeholder="Sueldo">
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="hora_extra_diurna_planilladevengo_aguinaldo" id="hora_extra_diurna_planilladevengo_aguinaldo" placeholder="Hora Extra Diurna" calculo="calculo_extra_diurna" readonly>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="hora_extra_nocturna_planilladevengo_aguinaldo" id="hora_extra_nocturna_planilladevengo_aguinaldo" placeholder="Hora Extra Nocturna" calculo="calculo_extra_nocturna" readonly>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="hora_extra_domingo_planilladevengo_aguinaldo" id="hora_extra_domingo_planilladevengo_aguinaldo" placeholder="Hora Extra Domingo" calculo="calculo_extra_domingo" readonly>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="hora_extra_domingo_nocturna_planilladevengo_aguinaldo" id="hora_extra_domingo_nocturna_planilladevengo_aguinaldo" placeholder="Hora Extra Domingo Nocturna" calculo="calculo_extra_domingo_noctu" readonly>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="otro_devengo_aguinaldo_planilladevengo_aguinaldo" id="otro_devengo_aguinaldo_planilladevengo_aguinaldo" placeholder="Otro devengo_aguinaldo" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="total_devengo_aguinaldo_planilladevengo_aguinaldo" id="total_devengo_aguinaldo_planilladevengo_aguinaldo" placeholder="Total Devengado" style="border:1px solid green;" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="descuento_isss_planilladevengo_aguinaldo" id="descuento_isss_planilladevengo_aguinaldo" placeholder="Descuento ISSS" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="descuento_afp_planilladevengo_aguinaldo" id="descuento_afp_planilladevengo_aguinaldo" placeholder="Descuento AFP" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="descuento_renta_planilladevengo_aguinaldo" id="descuento_renta_planilladevengo_aguinaldo" placeholder="Descuento Renta" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="otro_descuento_planilladevengo_aguinaldo" id="otro_descuento_planilladevengo_aguinaldo" placeholder="Otro Descuento" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="total_descuento_planilladevengo_aguinaldo" id="total_descuento_planilladevengo_aguinaldo" placeholder="Total Descuento" style="border:1px solid red;" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="total_liquidado_planilladevengo_aguinaldo" id="total_liquidado_planilladevengo_aguinaldo" placeholder="Total Liquidado" value="0" style="border:1px solid blue;" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="sueldo_renta_planilladevengo_aguinaldo" id="sueldo_renta_planilladevengo_aguinaldo" placeholder="Sueldo Renta" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="sueldo_isss_planilladevengo_aguinaldo" id="sueldo_isss_planilladevengo_aguinaldo" placeholder="Sueldo ISSS" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="sueldo_afp_planilladevengo_aguinaldo" id="sueldo_afp_planilladevengo_aguinaldo" placeholder="Sueldo AFP">
                  </div>
              </div>
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control mi-selector"  name="departamento_planilladevengo_aguinaldo" id="departamento_planilladevengo_aguinaldo" >
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="hidden" name="codigo_ubicacion_planilladevengo_aguinaldo" id="codigo_ubicacion_planilladevengo_aguinaldo">

                    <input type="text" class="form-control " name="nombre_ubicacion_planilladevengo_aguinaldo" id="nombre_ubicacion_planilladevengo_aguinaldo" placeholder="Ubicación" readonly>

                    <input type="hidden" name="id_ubicacion_planilladevengo_aguinaldo" id="id_ubicacion_planilladevengo_aguinaldo">
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="observacion_planilladevengo_aguinaldo" id="observacion_planilladevengo_aguinaldo" placeholder="Observación">
                  </div>
              </div>
...
<input type="hidden"  id="devengodevengo_aguinaldo">
