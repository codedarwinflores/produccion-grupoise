      ...
      <?php
        ...
        function fun_planilla_admin($fecha_desde,$fecha_hasta) {
            /* $query = "SELECT sum(total_devengo_admin_planilladevengo_admin) as totaldevengado,
                             ...
                             where tbl_empleados.id=planilladevengo_admin.id_empleado_planilladevengo_admin and STR_TO_DATE(fecha_planilladevengo_admin, '%d-%m-%Y') >= STR_TO_DATE('$fecha_desde', '%d-%m-%Y') and STR_TO_DATE(fecha_planilladevengo_admin, '%d-%m-%Y') <= STR_TO_DATE('$fecha_hasta', '%d-%m-%Y')  
        ...
        function funadminissssinemple() {
            $query = "SELECT sum(descuento_isss_planilladevengo_admin) as totalisss,
                             sum(descuento_afp_planilladevengo_admin) as totalafp,
                             sum(sueldo_isss_planilladevengo_admin) as totalsujetoisss,
                             sum(sueldo_afp_planilladevengo_admin) as totalsujetoafp,
                             sum(sueldo_renta_planilladevengo_admin) as totalsujetorenta,
                             sum(descuento_renta_planilladevengo_admin) as totalrenta,
                             sum(total_liquidado_planilladevengo_admin) as totalliquido,
                             sum(dias_trabajo_planilladevengo_admin) as totaldias,
                             planilladevengo_admin.* FROM planilladevengo_admin, tbl_empleados 
                             where tbl_empleados.id=planilladevengo_admin.id_empleado_planilladevengo_admin
                             group by id_empleado_planilladevengo_admin ";
            $sql = Conexion::conectar()->prepare($query);
                ...
                <table  class="table table-bordered table-striped dt-responsive tablas" width="100%" id="tabladatos">
                    ...
                    <tbody> 
                        <?php
                                        ...
                                        if ($val_empleado["id_departamento_empresa"] == $id_depa) {
                                            ...
                                            foreach ($array_isss as $val_isss) {
                                                if($val_isss["id_empleado_planilladevengo_admin"]==$idempleado_admin){
                                                    ...
                                                    $valor_sujero_isss=floatval($val_isss["totalsujetoisss"]);
                                                    $valor_renta=floatval($val_isss["totalrenta"]);
                                                    $valor_sujero_renta=floatval($val_isss["totalsujetorenta"]);
                                                    $valor_afp=floatval($val_isss["totalafp"]);
                                                    $valor_sujero_afp=floatval($val_isss["totalsujetoafp"]);
                                                    $valor_liquido=floatval($val_isss["totalliquido"]);
                                                    $valor_dias=floatval($val_isss["totaldias"]);
                                                }
                                            }
                                            ...
                                            $isss_global+=floatval(bcdiv($valor_isss,'1', 2));
                                            $afp_global+=floatval(bcdiv($valor_afp,'1', 2));
                                            $renta_global+=floatval(bcdiv($valor_renta,'1', 2));
                                            $sujetorenta_global+=floatval(bcdiv($valor_sujero_renta,'1', 2));
                                            $aguinaldo_global+=floatval(bcdiv($liquidoaguinaldo,'1', 2));

                                            $html.="<tr>";
                                            $html.="<td>".$val_empleado["codigo_empleado"]."</td>";
                                            $html.="<td>".$apellidos." ".$nombre_cargo."</td>";
                                            $html.="<td>".$val_empleado["nit"]."</td>";
                                            $html.="<td>".bcdiv($capture_devengado,'1', 2)."</td>";
                                            $html.="<td>".bcdiv($valor_isss,'1', 2)."</td>";
                                            $html.="<td>".bcdiv($valor_sujero_isss,'1', 2)."</td>";
                                            $html.="<td>".bcdiv($valor_afp,'1', 2)."</td>";
                                            $html.="<td>".bcdiv($valor_sujero_afp,'1', 2)."</td>";
                                            $html.="<td>".bcdiv($valor_renta,'1', 2)."</td>";
                                            $html.="<td>".bcdiv($valor_sujero_renta,'1', 2)."</td>";
                                            $html.="<td>".bcdiv($valor_liquido,'1', 2)."</td>";
                                            $html.="<td>".$valor_dias."</td>";
                                            $html.="<td>".bcdiv($liquidoaguinaldo,'1', 2)."</td>";
                                            $html.="</tr>";
                            ...
                            $html.="<td>".bcdiv($sujetorenta_global,'1', 2)."</td>";
                            $html.="<td>"."</td>";
                            $html.="<td>"."</td>";
                            $html.="<td>".bcdiv($aguinaldo_global,'1', 2)."</td>";
                            $html.="</tr>";
