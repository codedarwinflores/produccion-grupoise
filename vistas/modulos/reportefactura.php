                    ...
                    <tbody> 
                        <?php
                            ...
                            foreach ($array_ubicacion as $ubicacion) {
                                ...
                                if (!isset($agrupado[$rubro][$forma_pago][$tipo_documento][$nombre_ubicacion])) {
                                    $agrupado[$rubro][$forma_pago][$tipo_documento][$nombre_ubicacion] = array(
                                ...
                                $agrupado[$rubro][$forma_pago][$tipo_documento][$nombre_ubicacion]['detalle'][] = $ubicacion;
                                $agrupado[$rubro][$forma_pago][$tipo_documento][$nombre_ubicacion]['total'] += $total;
                            ...
                            foreach ($agrupado as $rubro => $rubroData) {
                                ...
                                $html .= "</tr>";
                                foreach ($rubroData as $forma_pago => $formaPagoData) {
                                    $html.="<tr>";
                                    $html.="<td class='colspan'>FORMA DE PAGO : ".$forma_pago."</td>";
                                    $html.="</tr>";
                                    foreach ($formaPagoData as $tipo_documento => $tipoDocumentoData) {
                                        $html .= "<tr>";
                                        $html .= "<td class='colspan'>DOCUMENTO " . $tipo_documento . "</td>";
                                        $html .= "</tr>";
                                        /* foreach ($tipoDocumentoData as $ubicacion) { */
                                        /* foreach ($tipoDocumentoData as $nombre_ubicacion => $ubicacion) { */
                                        /* foreach ($tipoDocumentoData as $nombre_ubicacion => $ubicacion) { */
                                        foreach ($tipoDocumentoData as $nombre_ubicacion => $ubicacionData) {
                                            ...
                                            $html .= "<td >" ."</td>";
                                            $html .= "<td >" ."</td>";
                                            $html .= "<td >" .bcdiv($ubicacionData['total'],'1', 2)."</td>";
                                            $html .= "<td >" ."</td>";
                                            $html .= "</tr>";
                                            $facturar_total_global+=bcdiv($ubicacionData['total'],'1', 2);
                                        }
                                    }
                                }
                            }
                            ...
                            $html .= "<td >" . $cuenta_empleados_global . "</td>";
                            $html .= "<td >" . "</td>";
