...
thead {
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <a href='vistas/modulos/Reporte_personal_con_ANSP.xlsx' download class="btn btn-primary btnreporte" style="display:none">
        Descargar archivo
      </a>
      ...
      <div class="col-md-12" align="center">
        <h3>Reporte de Empleados con ANSP</h3>
      </div>
      <!-- *********************** -->
      ...
      <?php
        ...
        function empleados() {
            ...
            $query = "SELECT * FROM `tbl_empleados`  where curso_ansp='Si'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
      ...
      <!-- ************************ -->
            ...
            <?php
                ...
                $writer->writeToFile('vistas/modulos/Reporte_personal_con_ANSP.xlsx');
                ?>
