      ...
      <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
         ...
         <?php
            function kardex()
            {
                  ...
                  where historial_kardex.transancion_kardexh=tbl_transacciones_equipo.id and historial_kardex.equipo_kardexh=tbl_radios.codigo_radio and historial_kardex.ubicacion_kardexh= tbl_clientes_ubicaciones.id  group by correlativo_kardexh";
           ...
           echo ' <tr>
                   ...
                   echo '<td>
                     ...
                     <div class="btn-group">
                       <a href="detalletransancionkardexradios?id='.$value["correlativo_kardexh"].'" class="btn btn-warning">Detalle</a>
