...
parse_str($components['query'], $results);
  $id= $results['id'];
  echo "<input type='hidden' class='idplanilladevengo_anticipo' value='".$id."'>";
  ...
  /* ********************* */
    ...
    function validarempleado01($e)
		{
					$query01 = "SELECT * FROM planilladevengo_anticipo WHERE numero_planilladevengo_anticipo='$e' ";
					$sql = Conexion::conectar()->prepare($query01);
					$sql->execute();
					return $sql->fetchAll();
		}
    ...
    ?>
    <input type="hidden" class="tipo_planilladevengo_anticipo1" value="<?php echo $value["tipo_planilladevengo_anticipo"]?>">
    <input type="hidden" class="periodo_planilladevengo_anticipo1" value="<?php echo $value["periodo_planilladevengo_anticipo"]?>">
    <input type="hidden" class="fecha_desde_planilladevengo_anticipo1" value="<?php echo $value["fecha_desde_planilladevengo_anticipo"]?>">
    <input type="hidden" class="fecha_hasta_planilladevengo_anticipo1" value="<?php echo $value["fecha_hasta_planilladevengo_anticipo"]?>">
    <input type="hidden" class="numero_planilladevengo_anticipo1" value="<?php echo $value["numero_planilladevengo_anticipo"]?>">
    <input type="hidden" class="fecha_planilladevengo_anticipo1" value="<?php echo $value["fecha_planilladevengo_anticipo"]?>">
    <input type="hidden" class="descripcion_planilladevengo_anticipo1" value="<?php echo $value["descripcion_planilladevengo_anticipo"]?>">
        ...
        <div class="col-md-9">
            ...
            <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control " name="tipo_planilladevengo_anticipo" id="tipo_planilladevengo_anticipo" placeholder="Tipo Planilla" value="Anticipo">
                </div>
            </div>
          ...
          <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select class=" form-control " name="periodo_planilladevengo_anticipo" id="periodo_planilladevengo_anticipo" placeholder="Periodo">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="calendario form-control " name="fecha_desde_planilladevengo_anticipo" id="fecha_desde_planilladevengo_anticipo"   data-lang="es" data-years="2010-2060" data-format="DD-MM-YYYY" readonly placeholder="Fecha Desde">
              </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                  <label for="exampleInputEmail1">Fecha Hasta:</label>
                  <input type="text" class="calendario form-control " name="fecha_hasta_planilladevengo_anticipo" id="fecha_hasta_planilladevengo_anticipo"   data-lang="es" data-years="2010-2060" data-format="DD-MM-YYYY" readonly placeholder="Fecha Hasta">
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" class=" form-control " name="numero_planilladevengo_anticipo" id="numero_planilladevengo_anticipo"   placeholder="Número" readonly>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                  <label for="exampleInputEmail1">Fecha Al:</label>
                  <input type="text" class="calendario form-control " name="fecha_planilladevengo_anticipo" id="fecha_planilladevengo_anticipo"   readonly placeholder="Fecha">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class=" form-control " name="descripcion_planilladevengo_anticipo" id="descripcion_planilladevengo_anticipo" placeholder="Fecha" value="Planilla de Anticipo desde">
                </div>
            </div>
  ...
  <!-- *************************** -->
          ...
          <!-- ***************** -->
            ...
            <div class="row box-body">
              <div class="col-md-4 box-body">
                <button class="btn btn-primary mostrar_devengo_anticipo" tipo="Suma" data-toggle="modal" data-target="#myModal" disabled="disabled">Agregar Devengo</button>
              </div>

              <div class="col-md-4 box-body">
                <button class="btn btn-success mostrar_devengo_anticipo" tipo="Resta" data-toggle="modal" data-target="#descuento" disabled="disabled">Agregar Descuento</button>
              </div>
        ...
        <div class="col-md-8" id="formulario_original" >
          ...
          <!-- ***************** -->
            ...
            <input type="hidden" name="codigo_empleado_planilladevengo_anticipo" id="codigo_empleado_planilladevengo_anticipo">
            <input type="hidden" name="nombre_empleado_planilladevengo_anticipo" id="nombre_empleado_planilladevengo_anticipo">
            <input type="hidden" name="id_empleado_planilladevengo_anticipo" id="id_empleado_planilladevengo_anticipo">
            <div class="col-md-12">
            <div class="form-group"> <label>Empleado Seleccionado: <span id="nombreempleado"></span></label></div>
              ...
              <div class="col-md-2 ocultar_div">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="dias_trabajo_planilladevengo_anticipo" id="dias_trabajo_planilladevengo_anticipo" placeholder="Dias Trabajado">
                  </div>
              </div>
              ...
              <div class="col-md-4 ocultar_div">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="sueldo_planilladevengo_anticipo" id="sueldo_planilladevengo_anticipo" placeholder="Sueldo">
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control dinero_mascara" name="hora_extra_diurna_planilladevengo_anticipo" id="hora_extra_diurna_planilladevengo_anticipo" placeholder="Hora Extra Diurna" calculo="calculo_extra_diurna" >
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="hora_extra_nocturna_planilladevengo_anticipo" id="hora_extra_nocturna_planilladevengo_anticipo" placeholder="Hora Extra Nocturna" calculo="calculo_extra_nocturna" >
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="hora_extra_domingo_planilladevengo_anticipo" id="hora_extra_domingo_planilladevengo_anticipo" placeholder="Hora Extra Domingo" calculo="calculo_extra_domingo" >
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="hora_extra_domingo_nocturna_planilladevengo_anticipo" id="hora_extra_domingo_nocturna_planilladevengo_anticipo" placeholder="Hora Extra Domingo Nocturna" calculo="calculo_extra_domingo_noctu" >
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="otro_devengo_anticipo_planilladevengo_anticipo" id="otro_devengo_anticipo_planilladevengo_anticipo" placeholder="Otro devengo_anticipo" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="total_devengo_anticipo_planilladevengo_anticipo" id="total_devengo_anticipo_planilladevengo_anticipo" placeholder="Total Devengado" style="border:1px solid green;" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="descuento_isss_planilladevengo_anticipo" id="descuento_isss_planilladevengo_anticipo" placeholder="Descuento ISSS" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="descuento_afp_planilladevengo_anticipo" id="descuento_afp_planilladevengo_anticipo" placeholder="Descuento AFP" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="descuento_renta_planilladevengo_anticipo" id="descuento_renta_planilladevengo_anticipo" placeholder="Descuento Renta" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="otro_descuento_planilladevengo_anticipo" id="otro_descuento_planilladevengo_anticipo" placeholder="Otro Descuento" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="total_descuento_planilladevengo_anticipo" id="total_descuento_planilladevengo_anticipo" placeholder="Total Descuento" style="border:1px solid red;" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="total_liquidado_planilladevengo_anticipo" id="total_liquidado_planilladevengo_anticipo" placeholder="Total Liquidado" value="0" style="border:1px solid blue;" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="sueldo_renta_planilladevengo_anticipo" id="sueldo_renta_planilladevengo_anticipo" placeholder="Sueldo Renta" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="sueldo_isss_planilladevengo_anticipo" id="sueldo_isss_planilladevengo_anticipo" placeholder="Sueldo ISSS" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="sueldo_afp_planilladevengo_anticipo" id="sueldo_afp_planilladevengo_anticipo" placeholder="Sueldo AFP" readonly>
                  </div>
              </div>
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control mi-selector" name="departamento_planilladevengo_anticipo" id="departamento_planilladevengo_anticipo">
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="hidden" name="codigo_ubicacion_planilladevengo_anticipo" id="codigo_ubicacion_planilladevengo_anticipo">

                    <input type="text" class="form-control " name="nombre_ubicacion_planilladevengo_anticipo" id="nombre_ubicacion_planilladevengo_anticipo" placeholder="Ubicación" readonly>

                    <input type="hidden" name="id_ubicacion_planilladevengo_anticipo" id="id_ubicacion_planilladevengo_anticipo">
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="observacion_planilladevengo_anticipo" id="observacion_planilladevengo_anticipo" placeholder="Observación">
                  </div>
              </div>
...
<input type="hidden"  id="devengodevengo_anticipo">
