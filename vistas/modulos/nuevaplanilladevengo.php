            ...
            <div class="form-group"> <label>Empleado Seleccionado: <span id="nombreempleado"></span></label></div>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class=" form-control " name="hora_extra_diurna_planilladevengo_anticipo" id="hora_extra_diurna_planilladevengo_anticipo" placeholder="Hora Extra Diurna" calculo="calculo_extra_diurna" >
