           ...
           ?>
            <div class="form-group <?php echo $row['Field'];?>">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg personalinput_<?php echo $row['Field'];?>" name="nuevo<?php echo $row['Field'];?>" placeholder="" value="" autocomplete="off" required>
