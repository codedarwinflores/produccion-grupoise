...
$html.="<table class='tabla'>";
    $html.="<tr>";
        ...
        $html.="<td class='ancho'>".
                    ...
                    autentica por haber sido puesta en mi presencia de su pu±o y letra por el Sr. ".$repre_legal." quien es de ".numeroALetras($edad)." años de edad, estudiante de este domicilio,a quien conozco e identifico por su cedula de identidad personal numero xxxxxxxxxxxxxxxxx SONSONATE,06 DE OCTUBRE DE 2022</span><br><br>".
