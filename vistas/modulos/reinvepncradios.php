  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_radio() {
            $query = "SELECT*FROM tbl_radios  
            where estado_radio='Activo'
            order by marca asc";  
                ...
                <table  class="table table-bordered table-striped dt-responsive" width="100%" id="tabladatos">
                    ...
                    <tbody> 
                        <?php
                            ...
                            $data_empleado=fun_radio();
                            foreach ($data_empleado as $val_emple) {
                              
                            $html .= "<tr>";
                            $html .= "<td>INVESTIGACIONES Y SEGURIDAD S.A. DE C.V.;"."</td>";
                            $html .= "<td>MOVIL;"."</td>";
                            $html .= "<td>".$val_emple["numero_serie"]."</td>";
                            $html .= "<td>;"."</td>";
                            $html .= "<td>".$val_emple["marca"]."</td>";
                            $html .= "<td>;"."</td>";
                            $html .= "<td>".strtoupper($val_emple["modelo_radio"])."</td>";
                            $html .= "</tr>";
...
<script>
    ...
    $("#exportExcel").click(function () {
       ...
       /*  ws['!cols'][0] = { wch: 10, };
        ...
        XLSX.writeFile(wb, "INFORMES PNC BOTON INVENTARIOS PERSONAL.csv");
