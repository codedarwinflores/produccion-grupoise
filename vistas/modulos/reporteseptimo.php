 ...
 <style>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <a href='vistas/modulos/Reporte_septimos.xlsx' download class="btn btn-primary btnreporte" style="display:none">
        Descargar archivo
      </a>
      ...
      $numero=$_POST["numero"];
        ...
        function planilla_admin($numero) {
            $query = "SELECT * FROM `planilladevengo_admin` where septimo_admin!='' and numero_planilladevengo_admin='$numero'  and dias_ausencia IS NOT NULL and septimo_admin != '0' and septimo_admin != '00'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
        function planilla_admin_data($numero) {
            $query = "SELECT * FROM `planilladevengo_admin` where septimo_admin!='' and numero_planilladevengo_admin='$numero' limit 1";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
                ...
                <table  class="table table-bordered table-striped dt-responsive tablas" width="100%">
                    ...
                    <?php
                        ...
                        foreach($data_planilla_admin as $row_data_planilla_admin) {
                            ...
                            $hora_extra=$row_data_planilla_admin["septimo_admin"];
                    ...
                    ?>                          
                            ...
                            <tr>
                                ...
                                <td><?php echo $row_data_planilla_admin["septimo_admin"]?></td>
                                <?php
      ...
      <!-- ************************ -->
            ...
            <?php
                ...
                $header2['            ']='string';
                $header2['           ']='string';
                $header2['LISTADO DE SEPTIMOS']='string';
                $header2['        ']='string';
                $header2['       ']='string';
                $header2['      ']='string';
                $header2['']='string';
                ...
                foreach($data_planilla_admin as $row_data_planilla_admin) {
                    ...
                    $hora_extra=$row_data_planilla_admin["septimo_admin"];
                        ...
                        $septimo_admin =$row_data_planilla_admin["septimo_admin"];
                ...
                $writer->writeToFile('vistas/modulos/Reporte_septimos.xlsx');
                ?>
