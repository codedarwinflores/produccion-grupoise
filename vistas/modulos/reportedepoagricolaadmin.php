                ...
                <table  class="table table-bordered table-striped dt-responsive tablas" width="100%" id="tabladatos">
                    ...
                    ?>                
                                ...
                                <tr>
                                        ...
                                        <td>
                                             <?php 
                                                $data_devengo=devengos($idempleado,$numero,$devengos_table_maestra);
                                                $valodevengono_grabado=0;
                                                foreach($data_devengo as $row_devengo) {
                                                    $valodevengono_grabado=floatval($row_devengo["sumadevengo"]);
                                                }
                                                
                                                $sumagrabado=floatval($row_data_planilla_admin["total_liquidado_planilladevengo".$cambio_table.""])-$valodevengono_grabado;
