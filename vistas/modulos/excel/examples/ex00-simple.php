...
$header = array(
  'c1-textssssssssssssssssssssssssssssssss'=>'string',//text
  'c2-text'=>'@',//text
  'c3-integer'=>'integer',
  'c4-integer'=>'0',
  'c5-price'=>'price',
...
$rows2 = array(
  array('HOLAAAAAAAAAA1'),
  array('HOLAAAAAAAAAA2')
);


$writer = new XLSXWriter();
$writer->writeSheetHeader('Sheet1', $header, $col_options = ['widths'=>[10,20,30,40]]);
foreach($rows2 as $rows01){
  $writer->writeSheetRow('Sheet1', $rows01);
  foreach($rows as $row){
...
$writer->writeToFile('wilman.xlsx');
//$writer->writeToStdOut();
//echo $writer->writeToString();

?>

<a href="wilman.xlsx">descargar</a>