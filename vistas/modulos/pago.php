          ...
          <input type="text" name="nuevosaldo_actual" class="nsaldo_actual" style="display: none;">
            ...
            <div class="form-group   " bis_skin_checked="1">
              ...
              <div class="input-group">
                  ...
                  <input type="text" value="" class="calendario nuevofecha_pedido form-control input-lg" data-lang="es" data-years="1600-2060" data-format="DD-MM-YYYY"  name="" fecha="nuevofecha_pedido" placeholder="Ingresar Fecha" required readonly>
 ...
 -->
          ...
          <input type="text" name="editarsaldo_actual" id="editarsaldo_actual" class="esaldo_actual" style="display: none;">
            ...
            <label for="">Ingresar Fecha</label>
              ...
              <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                  <input type="text" value="" class="calendario editarfecha_pedido form-control input-lg" data-lang="es" data-years="1600-2060" data-format="DD-MM-YYYY"  name="" fecha="editarfecha_pedido" placeholder="Ingresar Fecha" required id="editarfecha2" readonly>
