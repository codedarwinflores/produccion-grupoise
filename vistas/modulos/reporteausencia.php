 ...
 <style>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <a href='vistas/modulos/Reporte Ausencias.xlsx' download class="btn btn-primary btnreporte" style="display:none">
        Descargar archivo
      </a>
      ...
      $numero=$_POST["numero"];
        ...
        function planilla_admin($numero) {
            $query = "SELECT * FROM `planilladevengo_admin` where dias_ausencia!='' and numero_planilladevengo_admin='$numero' and dias_ausencia IS NOT NULL and dias_ausencia != '0' and dias_ausencia != '00'";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
        function planilla_admin_data($numero) {
            $query = "SELECT * FROM `planilladevengo_admin` where dias_ausencia!='' and numero_planilladevengo_admin='$numero' limit 1";
            $sql = Conexion::conectar()->prepare($query);
            $sql->execute();			
            return $sql->fetchAll();
        };
                ...
                <table  class="table table-bordered table-striped dt-responsive tablas" width="100%">
                    ...
                    <?php
                        ...
                        foreach($data_planilla_admin as $row_data_planilla_admin) {
                            ...
                            $hora_extra=$row_data_planilla_admin["dias_ausencia"];

                            $global_cantidad+=floatval($row_data_planilla_admin["dias_ausencia"]);
                    ?>                          
         
                            <tr>
                                <td><?php echo $row_data_planilla_admin["nombre_empleado_planilladevengo_admin"]?></td>
                                <td><?php echo $row_data_planilla_admin["dias_ausencia"]?></td>
                                <?php
      ...
      <!-- ************************ -->
            ...
            <?php
                ...
                $header2['            ']='string';
                $header2['           ']='string';
                $header2['LISTADO DE AUSENCIAS']='string';
                $header2['        ']='string';
                $header2['       ']='string';
                $header2['      ']='string';
                $header2['']='string';
                ...
                foreach($data_planilla_admin as $row_data_planilla_admin) {
                    ...
                    $hora_extra=$row_data_planilla_admin["dias_ausencia"];
                        ...
                        $septimo_admin =$row_data_planilla_admin["dias_ausencia"];
                        ...
                        $row_empleado[$septimo_admin]='string';
                ...
                $writer->writeToFile('vistas/modulos/Reporte Ausencias.xlsx');
                ?>
