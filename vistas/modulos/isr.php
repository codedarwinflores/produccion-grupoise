           ...
           ?>
            <div class="form-group <?php echo $row['Field'];?>">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg input_<?php echo $row['Field'];?> " name="nuevo<?php echo $row['Field'];?>" placeholder="" value="" required tabla_validar="isr" item_validar="codigo">
           ...
           ?>
            ...
            <label for="" class="label_<?php echo $row['Field'];?>"></label>
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg input_<?php echo $row['Field'];?>" name="editar<?php echo $row['Field'];?>" id="editar<?php echo $row['Field'];?>" placeholder="" value="" required>
