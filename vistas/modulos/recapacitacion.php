  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php
        ...
        function fun_capaci($fechadesde,$fechahasta) {
            $query = "SELECT tbl_empleados_seminario.*,tbl_empleados.*,seminarios.nombre as nombre_semi FROM tbl_empleados_seminario,tbl_empleados,seminarios
            where fecha_realizacion >= '$fechadesde' and 
            fecha_realizacion <= '$fechahasta'  and 
            tbl_empleados.id=tbl_empleados_seminario.id_empleado and
            seminarios.id=tbl_empleados_seminario.id_seminario
            order by tbl_empleados_seminario.id desc";  
      ...
      <div class="table-responsive">
                <table  class="table table-bordered table-striped dt-responsive" width="100%" id="tabladatos">
                    <thead>
                        ...
                        <tr>
                            <th class="colspan">*** INFORME DE SEMINARIOS *** </th>
                        </tr>
                        <tr>
                    ...
                    <tbody> 
                        <?php
                            ...
                            $html .= "<tr>";
                            $html .= "<td> NOMBRE H.S.  "."</td>";
                            $html .= "<td>FECHA CAPACITACION"."</td>";
                            $html .= "<td> NOMBRE DE LA CAPACITACION"."</td>";
                            $html .= "<td>UBICACION"."</td>";
                            $html .= "</tr>";

                            $data_empleado=fun_capaci($fecha_desde,$fecha_hasta);
                            $cuenta=0;
                            foreach ($data_empleado as $val_emple) {
                                ...
                                $fecha_realizacion = strtotime($val_emple["fecha_realizacion"]);
                                $fecha_realizacion = date("d-m-Y", $fecha_realizacion);

                                $html .= "<tr>";
                                $html .= "<td>".$val_emple["codigo_empleado"]." ".$nombre_cargo."</td>";
                                $html .= "<td>".$fecha_realizacion."</td>";
                              
                                $html .= "<td>".$val_emple["nombre_semi"]."</td>";
                                $html .= "<td>".$val_emple["lugar_recibido"]."</td>";
