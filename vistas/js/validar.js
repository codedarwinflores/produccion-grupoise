...
$(document).on("change", "#nuevoid_ubicacion_pu", function (event) {
  ...
  var tabla_validar = $("#nuevoid_ubicacion_pu option:selected").attr(
    "tabla_validar"
  );
  var item_validar = $("#nuevoid_ubicacion_pu option:selected").attr(
    "item_validar"
  );
