...
$(document).ready(function(){
 ...
 $(".guardar").click(function() {
	...
	var nuevoid=$("#nuevoid").val();
	var fecha_desde=$("#fecha_desde").val();
	var fecha_hasta=$("#fecha_hasta").val();
	var editaridusuario=$("#editaridusuario").val();
	var modulo_cierre=$("#modulo_cierre").val();

	var dataString = 'nuevoid='+nuevoid+
					 '&fecha_desde='+fecha_desde+
					 '&fecha_hasta='+fecha_hasta+
					 '&editaridusuario='+editaridusuario+
					 '&modulo_cierre='+modulo_cierre+'';
	$.ajax({
		data: dataString,
  ...
  function mostrar(){
	...
	var dataString ="accion01=mostrar";
	$.ajax({
		data: dataString,
		url: "ajax/cierres.ajax.php",
		type: 'post',
  ...
  $(".tablas").on("click", ".eliminar", function(){
	...
	/* ******************* */
		...
		var dataString = 'nuevoid='+idcierre+
						'&accion01=eliminar';
		$.ajax({
			data: dataString,
			url: "ajax/cierres.ajax.php",
