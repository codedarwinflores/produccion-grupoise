...
$('#editarCARGO0').on('change', function() {
  ...
  /* ************* */
	...
	$('.estadoempleado').on('change', function() {
		...
		var editarSegundoNombre=$("#editarSegundoNombre").val();
		var editarTercerNombre=$("#editarTercerNombre").val();
		var editarPrimerApellido=$("#editarPrimerApellido").val();
		var editarSegundoApellido=$("#editarSegundoApellido").val();
		var editarfecha_contratacion =$(".editarfecha_contratacion").val();
		var idEmpleado =$("#idEmpleado").val();
		var nombre_completo=editarNombre+" "+editarSegundoNombre+" "+editarTercerNombre+" "+editarPrimerApellido+" "+editarSegundoApellido
		/* ****CAPTURO LA FECHA ACTUAL */
		const today = new Date();
		const yyyy = today.getFullYear();
		let mm = today.getMonth() + 1; // Months start at 0!
		...
		$("#nuevonombre_retiro").val(nombre_completo);
		$("#nuevofecha_contratacion_retiro").val(editarfecha_contratacion);
		$("#nuevoidempleado_retiro").val(idEmpleado);
		$("#nuevofecha_retiro").val(formattedToday);
		window.location.href = 'formretiro?id='+idEmpleado;

		/* $("#modalagregarinactivo").modal('show'); */
		}
