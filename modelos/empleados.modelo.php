...
class ModeloEmpleados
{
	...
	static public function mdlIngresarEmpleado($tabla, $datos)
	{
		...
		$stmt->bindParam(":id_departamento_empresa", $datos["id_departamento_empresa"], PDO::PARAM_STR);
		...
		$stmt->bindParam(":id_tipo_portacion", $datos["id_tipo_portacion"], PDO::PARAM_STR);
		...
		$stmt->bindParam(":id_tipo_planilla", $datos["id_tipo_planilla"], PDO::PARAM_STR);
	...
	static public function mdlEditarEmpleado($tabla, $datos)
	{
		...
		numero_telefono_trabajo_actual =:numero_telefono_trabajo_actual,
		carnet_empleado =:carnet_empleado,
