...
class Modelorecibo{
	...
	static public function mdlMostrar($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT recibos.id as idrecibo, tbl_empleados.*, usuarios.*, recibos.*, tbl_devengo_descuento.* FROM `recibos`, tbl_empleados, usuarios, tbl_devengo_descuento
			 WHERE recibos.empleado_recibo=tbl_empleados.id and recibos.user_recibo=usuarios.id and recibos.descuento_recibo=tbl_devengo_descuento.id  and recibos.id = :$item");
			...
			$stmt = Conexion::conectar()->prepare("SELECT recibos.id as idrecibo, tbl_empleados.*, usuarios.*, recibos.*, tbl_devengo_descuento.* FROM `recibos`, tbl_empleados, usuarios, tbl_devengo_descuento
			WHERE recibos.empleado_recibo=tbl_empleados.id and recibos.user_recibo=usuarios.id and recibos.descuento_recibo=tbl_devengo_descuento.id");
