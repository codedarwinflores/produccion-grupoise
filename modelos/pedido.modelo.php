...
$namecolumnas="";
$namecampos="";
$nombretabla_pedido="tbl_proveedores_pedidos";
class Modelopedido{
	...
	static public function mdlMostrar($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT tbl_proveedores_pedidos.id as idpedido , `fecha_pedido`, `id_proveedor`, `descripcion`, `monto`, proveedores.id as idproveedor, proveedores.codigo as codigo, proveedores.nombre as nombreproveedor
			FROM `tbl_proveedores_pedidos`, proveedores 
			where tbl_proveedores_pedidos.id_proveedor=proveedores.id and tbl_proveedores_pedidos.id = :$item");
			...
			$stmt = Conexion::conectar()->prepare("SELECT tbl_proveedores_pedidos.id as idpedido , `fecha_pedido`, `id_proveedor`, `descripcion`, `monto`, proveedores.id as idproveedor, proveedores.codigo as codigo, proveedores.nombre as nombreproveedor
			FROM `tbl_proveedores_pedidos`, proveedores 
			where tbl_proveedores_pedidos.id_proveedor=proveedores.id");
