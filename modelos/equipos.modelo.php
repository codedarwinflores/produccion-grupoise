...
class Modeloequipos{
	...
	static public function mdlMostrar($tabla, $item, $valor){
		...
		if($item != null){
			...
			/* $stmt = Conexion::conectar()->prepare("SELECT tbl_otros_equipos.id as idequipos, `id_familia`, `descripcion`, `numero_serie`, tbl_familia.id as idfamilia , tbl_familia.codigo as codigofamilia , tbl_familia.nombre as nombrefamilia, `correrlativo`,tipo_equipos,tipo_otros_equipos.id as idtipo, tipo_otros_equipos.codigo as codigotipo, tipo_otros_equipos.nombre as nombretipo,codigo_equipo ,descripcion_equipo ,costo_equipo ,modelo_equipo ,color_equipo  ,fecha_adquisicion ,observaciones, lugar_adquisicion, estado_otros_equipos  FROM `tbl_otros_equipos`, tbl_familia, tipo_otros_equipos WHERE tbl_otros_equipos.id_familia = tbl_familia.id and tipo_otros_equipos.id=tbl_otros_equipos.tipo_equipos and tbl_otros_equipos.id = :$item"); */

			$stmt = Conexion::conectar()->prepare("SELECT tbl_otros_equipos.id as idequipos, `id_familia`, `descripcion`, `numero_serie`, tipo_otros_equipos.id as idtipo, tipo_otros_equipos.codigo as codigotipo, tipo_otros_equipos.nombre as nombretipo,codigo_equipo ,descripcion_equipo ,costo_equipo ,modelo_equipo ,color_equipo  ,fecha_adquisicion ,observaciones, lugar_adquisicion, estado_otros_equipos,tipo_equipos  
			FROM `tbl_otros_equipos`, tipo_otros_equipos
			WHERE tipo_otros_equipos.id=tbl_otros_equipos.tipo_equipos and tbl_otros_equipos.id = :$item");
			...
			$stmt = Conexion::conectar()->prepare("SELECT tbl_otros_equipos.id as idequipos, `id_familia`, `descripcion`, `numero_serie`, tipo_otros_equipos.id as idtipo, tipo_otros_equipos.codigo as codigotipo, tipo_otros_equipos.nombre as nombretipo,codigo_equipo ,descripcion_equipo ,costo_equipo ,modelo_equipo ,color_equipo  ,fecha_adquisicion ,observaciones, lugar_adquisicion, estado_otros_equipos, tipo_equipos  
			FROM `tbl_otros_equipos`, tipo_otros_equipos
			WHERE tipo_otros_equipos.id=tbl_otros_equipos.tipo_equipos");
